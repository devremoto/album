  ...
  $.SOW = {
    ...
    init: function () {
      /**
			...
			**/ document.cookie =
        "cross-site-cookie=sow; " + $.SOW.globals.cookie_secure + ";path=/";
      // -- --
      ...
      if (window.performance) {
        ...
        window.onload = function () {
          if ($.SOW.config.sow__debug_enable === true) {
            ...
            $.SOW.helper.consoleLog(
              "+ PAGE DISPLAY: " + (__now - __start) + " milliseconds",
              "color: #6dbb30; font-size: 13px;"
            );
            $.SOW.helper.consoleLog(
              "+ DOM RENDERING:",
              "color: #6dbb30; font-size: 13px;"
            ...
            $.SOW.helper.consoleLog(
              "+ Depends on user hardware! First load is always expensive, next loads are using the cache! ",
            ...
            if (pageNav) {
              ...
              $.SOW.helper.consoleLog(
                "+ DNS Lookup time: " +
                  (pageNav.domainLookupEnd - pageNav.domainLookupStart) +
                  " seconds",
                "color: #6dbb30; font-size: 13px;"
              );
              $.SOW.helper.consoleLog(
                "+ Connection time: " +
                  (pageNav.connectEnd - pageNav.connectStart) +
                  " milliseconds",
                "color: #6dbb30; font-size: 13px;"
              );
              $.SOW.helper.consoleLog(
                "+ Cache Seek: " +
                  (pageNav.responseEnd - pageNav.fetchStart) +
                  " milliseconds",
                "color: #6dbb30; font-size: 13px;"
              );
              $.SOW.helper.consoleLog(
                "+ Compression Ratio: " +
                  pageNav.decodedBodySize / pageNav.encodedBodySize,
                "color: #6dbb30; font-size: 13px;"
              );
              $.SOW.helper.consoleLog(
                "+ Download Time: " +
                  (pageNav.responseEnd - pageNav.requestStart) +
                  " milliseconds",
                "color: #6dbb30; font-size: 13px;"
              );
            }
      ...
      $(document).ready(function () {
        ...
        if ($.SOW.config.sow__debug_enable === true) {
          ...
          $.SOW.helper.consoleLog(
            "+ CONSOLE DEBUG ENABLED : gulp.config.settings.js",
        ...
        $.SOW.helper
          .loadScript(
            [$.SOW.globals.js_location + "vendor_bundle.min.js"],
            false,
            true
          )
          .done(function () {
    ...
    globals: {
      ...
      is_modern_browser:
        ...
        "addEventListener" in window /* `true` if modern */,
      is_mobile: $(window).width() < 993 ? true : false,
      is_admin: $("body").hasClass("layout-admin") ? true : false,
      ajax_container:
        "body" /* DO NOT USE THIS IN YOUR SCRIPT, IS EXCLUSIVELY USED BY REINIT() FUNCTION */,
      page_first_load: true /* set by reinit() to false after first load - used by ajax */,
      js_location:
        "" /* javascripts location, used to dinamicaly load js scripts */,
    ...
    onresize: function () {
      ...
      jQuery(window).resize(function () {
        if (window.afterResizeApp) clearTimeout(window.afterResizeApp);
    ...
    reinit: function (ajax_container) {
      /*
			...
			*/
      $.SOW.globals.ajax_container =
        $.SOW.helper.check_var(ajax_container) || "body";
      ...
      $(
        ...
        .tooltip({
          container:
            $.SOW.globals.ajax_container == "body"
              ? "html"
              : $.SOW.globals.ajax_container /* fixing wired positioning! */,
        });
      ...
      /** Bootstrap Carousel **/
      $($.SOW.globals.ajax_container + " .carousel")
        .carousel("dispose")
        .carousel({
      ...
      for (var index in $.SOW.config.autoinit) {
        ...
        if (
          ...
          $.SOW.config.autoinit[index][3] === false
        )
          continue;
...
(function ($) {
  ...
  $.SOW.config = {
    ...
    /*
		...
		*/
    /* Icons */
    sow__icon_loading: "fa fa-circle-spin fi-spin", // ajax loading indicator
    sow__icon_check: "fa fa-check", // 'success' messages or other places
    sow__icon_close: "fa fa-close", // 'failed'  messages or other places
  };
})(jQuery);
/**
 *
...
(function ($) {
  ...
  $.SOW.helper = {
      ...
      if (
        ...
        if (selector.indexOf(",") > -1)
          var selector = selector
            .split(",")
            .join(", " + $.SOW.globals.ajax_container + " ");
    ...
    is_numeric: function (_var) {
      ...
      else if (_var.slice(-1) === ".") return false; // something like '1.'
    ...
    loadScript: function (script_arr, async, cache) {
      return async === true
        ? $.SOW.helper.__loadScriptAsync(script_arr, cache)
        : $.SOW.helper.__loadScriptOrdered(script_arr, cache);
    },
    ...
    __loadScriptAsync: function (script_arr, cache) {
      var _arr = $.map(script_arr, function (scr) {
        return cache !== false
          ? $.SOW.helper.getScriptCached(scr)
          : $.getScript(scr);
      });
    ...
    loadCSS: function (cssFile, option) {
      ...
      /* 2. prepend */ else if (option === "prepend") {
    ...
    /**
		 ...
		 *
		 **/
    loadingSpinner: function (option, _container, _layout) {
      // layout: overlay|icon

      var _container =
        _container === null ? jQuery("body") : jQuery(_container);
      ...
      if (option === "show") {
        ...
        var _tpl1 =
          '<div id="js_loading_icon" class="position-absolute absolute-full overlay-dark overlay-opacity-2 z-index-9999 text-center">' +
          '<i class="' +
          $.SOW.config.sow__icon_loading +
          ' fs--30 text-muted valign-middle"></i>' +
          "</div>";
    ...
    byte2size: function (bytes, precision, int_only) {
      ...
      if (bytes < 1) return 0 + (int_only === false) ? "B" : "";
      ...
      if (_el != "#" && _el != "#!" && _el != "javascript:;") {
        if (_el == "#top") {
          jQuery("html, body").animate(
            { scrollTop: $.SOW.globals.elBody.offset().top },
            _speed,
            function () {
          ...
          jQuery("html, body").animate(
            { scrollTop: jQuery(_el).offset().top - parseInt(_offset) },
            _speed,
            function () {
              if (_hash_change == "true") {
                window.location.hash = _el;
    ...
    removeUrlHash: function (_url) {
      if (_url.indexOf("#") > -1) return _url.replace(/#.*$/, "");
    ...
    indexedDB: function (_obj) {
      ...
      req.onsuccess = function (e) {
        ...
        if (action === "db:add") table.add(key);
        else if (action === "db:update") table.put(key);
        else if (action === "db:delete") table.delete(key);
        else if (action === "db:delete:database") table.clear();
          ...
          var _exists = smarty.db.objectStoreNames.contains(database)
            ? true
            : false;
          callback(_exists);
        }
    ...
    jsLocation: function () {
      ...
      if (!currentScript) currentScript = scripts[scripts.length - 1].src;

      if (!currentScript) currentScript = "assets/js/";
    ...
    cssLocation: function () {
      ...
      // nothing we want found! get the last script!
      if (!currentScript) currentScript = scripts[scripts.length - 1].href;

      if (!currentScript) currentScript = "assets/css/";
    ...
    vendorLogicPaths: function (vendor) {
      ...
      var js_location =
        $.SOW.globals.js_location != ""
          ? $.SOW.globals.js_location
          : $.SOW.helper.jsLocation();
      var css_location =
        $.SOW.globals.js_location != ""
          ? $.SOW.globals.css_location
          : $.SOW.helper.cssLocation();
      var arr = [];
      arr["path_js"] = "";
      arr["path_css"] = "";
      ...
      if ($.SOW.config["vendor:external_css"]) {
        for (var module in $.SOW.config["vendor:external_css"]) {
          for (
            var v = 0;
            v < $.SOW.config["vendor:external_css"][module].length;
            v++
          ) {
            if (
              $.SOW.config["vendor:external_css"][module].includes(vendor) ===
              true
            ) {
              arr["path_css"] =
                css_location + module + "." + vendor + ".min.css";
      ...
      if ($.SOW.config["vendor:external_js"]) {
        for (var module in $.SOW.config["vendor:external_js"]) {
          for (
            var v = 0;
            v < $.SOW.config["vendor:external_js"][module].length;
            v++
          ) {
            if (
              $.SOW.config["vendor:external_js"][module].includes(vendor) ===
              true
            ) {
    ...
    videoEmbedFromUrl: function (href, autoplay) {
      ...
      if (videoEmbedLink === null) {
        var youtubeMatch = href.match(
          /(youtube\.com|youtu\.be|youtube\-nocookie\.com)\/(watch\?(.*&)?v=|v\/|u\/|embed\/?)?(videoseries\?list=(.*)|[\w-]{11}|\?listType=(.*)&list=(.*))(.*)/i
        );
        var videoEmbedLink = youtubeMatch
      ...
      return (
        ...
        videoEmbedLink +
        '" allow="autoplay; encrypted-media" width="560" height="315"></iframe>' +
        "</div>"
      );
    },
    ...
    consoleLogReinit: function (scriptInfo, selector) {
      ...
      $.SOW.helper.consoleLog(
        scriptInfo,
        "color: #6dbb30; font-weight: bold; font-size:14px;"
      );
    ...
    consoleLog: function (data, css) {
      if ($.SOW.config.sow__debug_enable !== true) return;
...
(function () {
  ...
  $.SOW.vanilla = {
     ...
     **/ /*
		...
		*/
    ajax: function (o) {
      if (typeof o.beforeSend === "function") o.beforeSend();
    ...
    ajaxObj: {
      xhr: function () {
        ...
        alert(
          "Ajax not supported! Please, use a modern browser like Chrome, Mozilla..."
        );
        return null;
      },
...
(function ($) {
  ...
  $.SOW.core.header = {
     ...
     **/
    init: function (selector, config) {
      if (!$.SOW.globals.elHeader) return;
      ...
      /**
			...
			**/ else if (
        $.SOW.globals.elBody.hasClass("header-scroll-reveal")
      )
    ...
    header_sticky: function () {
      ...
      // Curently not used!
      // +++++++++++++++++++++++++++++++++++++++++++++++++++++++
      if ($.SOW.globals.elBody.hasClass("layout-admin")) return;
      // +++++++++++++++++++++++++++++++++++++++++++++++++++++++

      if ($.SOW.globals.elHeader.length < 1) return;
      ...
      if ($.SOW.globals.elBody.hasClass("layout-admin aside-sticky")) {
        jQuery("#middle").css({
          "padding-top":
            _headerEl_H +
            _diff +
            parseInt(jQuery("#middle").css("padding-top")),
        });
      } else {
        jQuery("#js_header_spacer").remove();
        // '#wrapper>'+window._headerID+', body>'+window._headerID
        jQuery(window._headerID).after(
          '<div id="js_header_spacer" style="height:' +
            (_headerEl_H + _diff) +
            'px"><!-- spacer added by header js --></div>'
        );
      }
      ...
      /*
			...
			*/
      if (
        $.SOW.globals.elBody.hasClass("header-over") &&
      ...
      /*
			...
			*/
      var top_bar_present = jQuery("#top_bar").length,
        top_bar_height =
          top_bar_present > 0 ? jQuery("#top_bar").outerHeight() : 0,
      ...
      setInterval(function () {
        if (didScroll) {
          $.SOW.core.header.header_sticky__hasScrolled(
            _headerEl_H,
            delta,
            top_bar_present,
            top_bar_height,
    ...
    header_sticky__hasScrolled: function (
      _headerEl_H,
      delta,
      top_bar_present,
      top_bar_height,
      ...
      if (top_bar_present > 0 && top_bar_js_ignore === false) {
        ...
        if (Math.abs(window.lastScrollTop - st) <= delta) return;

        if (st > window.lastScrollTop && st > _headerEl_H) {
          // Scroll Down
          $.SOW.globals.elHeader.css({
    ...
    header_scroll_reveal: function () {
      ...
      if ($.SOW.globals.elHeader.length > 0) {
        ...
        setInterval(function () {
          if (didScroll) {
            $.SOW.core.header.header_scroll_reveal__hasScrolled(
              _headerEl_H,
              delta
            );
            didScroll = false;
    ...
    header_scroll_reveal__hasScrolled: function (_headerEl_H, delta) {
      ...
      if (st < 1) {
        $.SOW.globals.elBody
          .addClass("header-is-on-top")
          .removeClass("user-scrolled-down");
      } else {
        $.SOW.globals.elBody.addClass("user-scrolled-down");
      }
    ...
    horizontal_nav: function () {
      if (jQuery("nav.horizontal-nav").length < 1) return;

      // CONTENT MAIN MENU
      if (jQuery("section nav.horizontal-nav").length > 0) {
        var _diffWidth =
            jQuery("section .container").width() -
            jQuery("section nav.horizontal-nav").width(),
          _navHeight = jQuery("section nav.horizontal-nav").height();

        // Submenu widh & height
        jQuery(
          "section nav.horizontal-nav>div>ul>li.main-nav-expanded>.main-nav-submenu"
        ).css({ width: _diffWidth + "px" });
        //jQuery("section nav.horizontal-nav>div>ul>li>.main-nav-submenu").css({"min-height":_navHeight+"px"});

        // SUBMENUS
        jQuery("section nav.horizontal-nav>div>ul>li").on(
          "click",
          function (e) {
            ...
            if (!jQuery("div", _this).hasClass("main-nav-open")) {
              jQuery(
                "section nav.horizontal-nav>div>ul>li>.main-nav-submenu"
      ...
      var _hdiffWidth = jQuery(window._headerID + " .container").width() - 278,
        _hdiffHeight = jQuery(
          window._headerID + " nav.horizontal-nav"
        ).height();

      // Submenu widh & height
      jQuery(
        window._headerID + " nav.horizontal-nav>div>ul>li>.main-nav-submenu"
      ).css({ "min-height": _hdiffHeight + "px" });
      jQuery(
        window._headerID +
          " nav.horizontal-nav>div>ul>li.main-nav-expanded>.main-nav-submenu"
      ).css({ width: _hdiffWidth + "px" });

      // SUBMENUS
      jQuery(window._headerID + " nav.horizontal-nav>div>ul>li").on(
        "click",
        function (e) {
          var _this = jQuery(this);
          ...
          if (!jQuery("div", _this).hasClass("main-nav-open")) {
            jQuery(
              window._headerID +
                " nav.horizontal-nav>div>ul>li>.main-nav-submenu"
            ).removeClass("main-nav-open");
          }
      ...
      $.SOW.globals.elBody.on(
        "click",
        "button.main-nav-horizontal, nav.horizontal-nav",
        function (e) {
          e.stopPropagation();
        }
      );
    ...
    _initMainNav: function () {
      ...
      // open menu
      jQuery(window._headerID + " nav.horizontal-nav").addClass(
        "min-nav-active"
      );
    ...
    header_toggle: function () {
      if (!document.querySelector(".btn-header-toggle")) return;

      jQuery(".btn-header-toggle").on("click", function (e) {
        e.preventDefault();

        var is_hidden = $.SOW.globals.elBody.hasClass("header-hide")
            ? true
            : false,
        ...
        if (is_hidden === false) {
          ...
          jQuery("#header" + _addEl).animate(
            ...
            0,
            function (e) {
              $.SOW.globals.elBody.removeClass(
                "header-hide btn-header-toggle-show"
              );
    ...
    header_onepagenav: function () {
      jQuery(".navbar-collapse").each(function () {
        ...
        jQuery(".scroll-to, .js-ajax", _t).on("click", function () {
          if ($.SOW.globals.is_mobile === true) _t.collapse("hide");
        });
      });
    },
    ...
    header_destroy: function () {
      ...
      $.SOW.globals.elBody.removeClass(
        "header-hide header-over header-fixed header-is-on-top user-scrolled-down"
      );
      $.SOW.globals.elHeader.css({ "margin-top": "" });
...
(function ($) {
  ...
  $.SOW.core.search_suggest = {
    ...
    init: function (selector, config) {
      ...
      this.config =
        __config !== null ? $.extend({}, this.config, __config) : this.config;

      if (jQuery(this.selector).length < 1) return;
    ...
    process: function (_this) {
      _this.each(function () {
        var _t = jQuery(this),
          ...
          json_icon_related =
            _t.data("json-related-item-icon") || "fa fa-star-empty", // JSON ONLY
          json_title_suggest =
            _t.data("json-suggest-title") || "Search Suggestion", // JSON ONLY
          json_noresult_txt =
            _t.data("json-suggest-noresult") || "No results for", // JSON ONLY
          json_icon_suggest =
            _t.data("json-suggest-item-icon") || "fa fa-search", // JSON ONLY
        ...
        if (
          ...
          return;
        else if (search_enable != "on") return;
        ...
        if (related_url == "" && suggest_url == "") {
          $.SOW.helper.consoleLog(
            "Search Suggest Error: No related and/or suggest url provided!"
          );
          return;
        }
        ...
        jQuery("input.form-control-sow-search", _t).focus(function (e) {
          var _autosuggestContent = jQuery(
            _container + " .sow-search-content"
          ).html();
          ...
          if (_autosuggestContent.length < 3) {
            ...
            if (window.afterSearchKeyUp) clearTimeout(window.afterSearchKeyUp);
            ...
            window.afterSearchKeyUp = setTimeout(function () {
              ...
              if ($.SOW.core.search_suggest.config.forceStringify === true)
                $.SOW.helper.consoleLog(
                  "JSON Related Sent: " + JSON.stringify(_formData)
                );
              else
                $.SOW.helper.consoleLog(
                  "Related Sent: " + JSON.stringify(_formData)
                );

              $.SOW.helper.consoleLog(
                "Url Request: " + related_url,
                "color: #cccccc;"
              );
              $.SOW.helper.consoleLog(
                "Mode: " + search_mode,
              ...
              jQuery.ajax({
                url: related_url,
                data:
                  $.SOW.core.search_suggest.config.forceStringify === true
                ...
                success: function (data) {
                  if (search_mode === "json")
                    var data = $.SOW.core.search_suggest.process_json(
                      data,
                      related_kw,
                      json_max_results,
                      json_title_realted,
        ...
        // USER KEY UP : SEARCH
        jQuery("input.form-control-sow-search", _t).on(
          "keyup change",
          function (e) {
            ...
            if (
              _keyInput.length >= Number(min_length) &&
              ...
              window.afterSearchKeyUp = setTimeout(function () {
                ...
                var _formData = {
                  ...
                  user_keywords: _keyInput,
                };

                // console log
                if ($.SOW.core.search_suggest.config.forceStringify === true)
                  $.SOW.helper.consoleLog(
                    "JSON Suggest Sent: " + JSON.stringify(_formData)
                  );
                else
                  $.SOW.helper.consoleLog(
                    "Related Suggest: " + JSON.stringify(_formData)
                  );
              ...
              if (window._relatedFirstLoad != "" && _keyInput == "") {
                jQuery(_container + " .sow-search-content").html(
                  window._relatedFirstLoad
                );
              }
            }
      ...
      jQuery(".btn-sow-search-toggler:not(.btn-sow-search-togglified)")
        ...
        .on("click", function (e) {
          ...
          if (jQuery(_target).hasClass("sow-search-mobile")) {
            ...
            $.SOW.globals.elBody.removeClass("overflow-hidden");
            jQuery(_target + ".sow-search-over")
              .addClass("hide")
    ...
    process_json: function (
      ...
      if (typeof fuzzy !== "function") {
        ...
        $.SOW.helper.consoleLog(
          " ERROR : " +
            scriptInfo +
            " : Require fuzzy.js Vendor for JSON search mode!",
          "color: #ff0000; font-weight: bold;"
        );
        // -- * --

        return (
          '<h3 class="fs--18 p--20 pb--10 m-0 text-danger">' +
          scriptInfo +
          " Error</h3>" +
      ...
      if (keyword != "") {
        ...
        if (_found < 1) {
          _tpl +=
            '<li class="list-item text-muted px-4 pb-4">' +
            json_noresult_txt +
            ' <i>"' +
            keyword +
            '"</i>' +
  ...
  $.SOW.core.lazyload = {
    ...
    config: {
      ...
      load: function load(element) {
        ...
        // mobile, if exists
        if (
          $.SOW.globals.is_mobile === true &&
          element.getAttribute("data-background-image-xs")
        )
          element.style.backgroundImage =
            "url('" + element.getAttribute("data-background-image-xs") + "')";
        ...
        if (element.getAttribute("data-lazy-toggle-class")) {
          jQuery(element).addClass(
            element.getAttribute("data-lazy-toggle-class")
          );
        ...
        jQuery(element).removeAttr(
          "data-lazy-toggle-class data-background-image data-srcset data-src"
        );
      },
    },
    ...
    process: function (selector) {
      ...
      if (window.IntersectionObserver) {
        __observer = new IntersectionObserver(
          $.SOW.core.lazyload.onIntersection(load),
          {
        ...
        // -- * --
        $.SOW.helper.consoleLog(
          "Lazyload: This browser does not support IntersectionObserver()"
        );
        $.SOW.helper.consoleLog("Images loaded without lazyloading!");
        $.SOW.helper.consoleLog(
          "To enable, download this polyfill and include before any other js script: https://www.npmjs.com/package/intersection-observer"
        );
        // -- * --
      }
      ...
      return {
        observe: function observe() {
          ...
          for (var i = 0; i < items.length; ++i) {
            if ($.SOW.core.lazyload.isLoaded(items[i])) continue;
      ...
      return function (items, __observer) {
        items.forEach(function (item) {
          if (item.intersectionRatio > 0 || item.isIntersecting) {
            ...
            if (__observer) __observer.unobserve(item.target);
...
(function ($) {
  ...
  $.SOW.core.ajax_navigation = {
    ...
    config: {
      ...
      AjaxOtherGarbage:
        ".datepicker, .popover, .daterangepicker, .modal, .modal-backdrop, .note-popover, #dropdown_toggle_overlay, .tooltip",
    },
    ...
    /**
		 ...
		 *
		 **/
    ajax_navigation: function (_this, ajax_navigation_reinit_skip) {
      // ajax_navigation_reinit_skip: used by calling from other plugins via __initFor(). DO NOT REMOVE!
      ...
      _this.on("click", function (e) {
        ...
        var _t = jQuery(this),
          ...
          _contentResponseExtract =
            _t.data("ajax-parser-extract-element") || "", // id|class (document container to get data from)
        ...
        if (
          !_t.hasClass("nav-link") &&
          typeof $.SOW.core.nav_deep === "object"
        ) {
          /**
          ...
          var __navHasThisLink = jQuery(
            _selector_orig + '.nav-link[href="' + _href + '"]'
          );
        ...
        /**
				...
				**/
        if (_scrollToContent == "")
          var _scrollToContent =
            $.SOW.core.ajax_navigation.config.autoscroll_to_content;

        if (_callback == "")
          var _callback = $.SOW.core.ajax_navigation.config.callback_function;

        if (_callbackBeforePush == "")
          var _callbackBeforePush =
            $.SOW.core.ajax_navigation.config.callback_before_push;
        ...
        if (_showLoadingIcon == "")
          var _showLoadingIcon =
            $.SOW.core.ajax_navigation.config.show_loading_icon;

        if (_container2El == "")
          var _container2El =
            $.SOW.core.ajax_navigation.config.container2_element;

        if (_container2Class == "")
          var _container2Class =
            $.SOW.core.ajax_navigation.config.container2_class;

        // --

        if (
          _contentResponseExtract == "" &&
          $.SOW.core.ajax_navigation.config.parser_extract_enable === true
        )
          /* default self config (se top config) */
          var _contentResponseExtract =
            $.SOW.core.ajax_navigation.config.parser_extract_element;
        ...
        /*
				...
				*/
        if (window.sow_ajax_links_last_href == _href) return;
        ...
        /**
					...
					**/
        return $.SOW.core.ajax_navigation.__ajaxLinkProcess(
          _obj,
          ajax_navigation_reinit_skip
        );
      });
    },
    ...
    __ajaxLinkProcess: function (_obj, ajax_navigation_reinit_skip) {
      if ($.SOW.core.ajax_navigation.config.enable !== true) return;
      ...
      jQuery.ajax({
        ...
        beforeSend: function () {
          ...
          if ($.SOW.globals.is_mobile === true) {
            if (
              $.SOW.globals.elBody.hasClass("layout-admin") &&
              jQuery("#aside-main").hasClass("js-aside-show")
            )
        ...
        error: function (XMLHttpRequest, textStatus, errorThrown) {
          // 404 error page
          var page_404_response = $.SOW.core.ajax_navigation.page_404(
            _contentResponseExtract,
            _target
          ); // should return true!
        ...
        success: function (data) {
          ...
          if (_callbackBeforePush == "false") {
            ...
            if (
              _contentResponseExtract == "" ||
              $.SOW.core.ajax_navigation.config.parser_extract_enable === false
            ) {
              /*
              ...
              /* ++ SEO ++
								...
								*/
              var seo_meta_title =
                  jQ_source.find("title").html() ||
                  jQ_source.find("meta-title").html(),
                seo_meta_description =
                  jQ_source.find("meta[name=description]").attr("content") ||
                  jQ_source.find("meta-description").html(),
                seo_meta_canonical =
                  jQ_source.find("link[rel=canonical]").attr("href") ||
                  jQ_source.find("meta-canonical").html(),
                seo_meta_robots =
                  jQ_source.find("meta[name=robots]").attr("content") ||
                  jQ_source.find("meta-robots").html();

              // Remove by default
              jQuery("link[rel=canonical], meta[name=robots]").remove();

              // Safe mode : update metas
              if (seo_meta_title) document.title = seo_meta_title;

              if (seo_meta_description)
                document
                  .querySelector('meta[name="description"]')
                  .setAttribute("content", seo_meta_description);
              ...
              if (
                parsed_data == "" &&
                $.SOW.core.ajax_navigation.config.parser_force_push2target ===
                  true
              )
              ...
              // Apply JS
              $.SOW.core.ajax_navigation.html_parsed__apply_scripts(
                script_src,
                script_inline
              );
              var jQ_source = null;

              if (_updateURL == "true") var __dataHtml = parsed_data;

              // Parse content and push
            } else {
              // Pase data
              var _objParsed = $.SOW.core.ajax_navigation.html_parse(
                _contentResponseExtract,
                data
              );
              ...
              // Push Scripts
              $.SOW.core.ajax_navigation.html_parsed__apply_scripts(
                _objParsed.scripts_src,
                _objParsed.scripts_inline
              );
            ...
            if (
              ...
              $.SOW.core.ajax_navigation.__historyPushState(
                _href,
                _href_title,
                _json
              );
            ...
            if ($.SOW.core.ajax_navigation.config.custom_function_call != "") {
              if (typeof $.SOW.helper.executeFunctionByName === "function")
                $.SOW.helper.executeFunctionByName(
                  $.SOW.core.ajax_navigation.config.custom_function_call,
                  window,
                  _t,
                  _target,
                  this.selector
          ...
          if (_callbackBeforePush == "true" && _callback == "")
            $.SOW.helper.consoleLog(
              'data-ajax-callback-function="" -BUT- data-ajax-callback-before-push="true"'
            );
    ...
    html_parse: function (_selectors, _data) {
      ...
      var jQ_source = jQuery("<div>" + _data + "</div>"),
        html_content = "",
        meta_title =
          jQ_source.find("title").html() || jQ_source.find("meta-title").html(),
        meta_description =
          jQ_source.find("meta[name=description]").attr("content") ||
          jQ_source.find("meta-description").html(),
    ...
    html_parsed__apply_scripts: function (scripts_src, scripts_inline) {
      ...
      $.SOW.helper.loadScript(scripts_src, false, true).done(function () {
        ...
        if (scripts_inline.length > 0) {
          $.SOW.globals.elBody.append(
            '<div id="js_ajax_navigation_appended_scripts"></div>'
          );

          for (var i in scripts_inline) {
            jQuery("#js_ajax_navigation_appended_scripts").append(
              scripts_inline[i]
            );
          }
        }
    ...
    page_404: function (_contentResponseExtract, _target) {
      if ($.SOW.core.ajax_navigation.config.page_404 == "") return null;
      ...
      jQuery.ajax({
        ...
        success: function (data) {
          ...
          if (typeof _objParsed !== "object") {
            ...
            $.SOW.core.ajax_navigation.__historyPushState(
              $.SOW.core.ajax_navigation.config.page_404,
              document.title,
              __dataHtml
            );
          }
          ...
          if (
            !__dataHtml &&
            $.SOW.core.ajax_navigation.config.parser_force_push2target === true
          )
            __dataHtml = data;
    ...
    __initFor: function (_container) {
      ...
      return $.SOW.core.ajax_navigation.ajax_navigation(
        jQuery(_container + " " + this.selector_orig),
        ajax_navigation_reinit_skip
      );
    },
    ...
    __cleanAjaxGarbage: function () {
      ...
      if (typeof $.SOW.core.toast === "object") $.SOW.core.toast.destroy();
      ...
      if (typeof window.onpopstate !== "function") {
        window.onpopstate = function (e) {
          if (e.state) {
            ...
            if (_obj._href == "") {
              $.SOW.helper.consoleLog(
                "SOW Ajax : history.pushState : Err : Missing Back Link! Displayed the page from history, no real request to the server reload!"
              );
              return;
            }
            ...
            var _t = jQuery(
              _selector_orig + '[href="' + _obj._href + '"]'
            ).first();
            ...
            if ($.SOW.core.ajax_navigation.config.onpopstate_reload === true) {
              ...
              $.SOW.helper.consoleLog(
                "SOW Ajax : onpopstate : Content request sent to the server!"
              );
            }
            /* --------------------------------------------------------------------------- */
  ...
  $.SOW.core.ajax_content = {
    ...
    init: function (selector, config) {
      ...
      /*
			...
			*/
      if (jQuery(this.selector_orig).last().hasClass("js-ajaxified")) return;
      // -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
    ...
    ajax_content: function (_this) {
      if (_this.hasClass(".js-ajaxified") || _this.length < 1) return;
      ...
      var _id = _this.attr("id") || "",
        ...
        _callback =
          _this.data("ajax-callback-function") ||
          $.SOW.core.ajax_content.config.callback_function,
        _callbackBeforePush =
          _this.data("ajax-callback-before-push") ||
          $.SOW.core.ajax_content.config.callback_before_push,
        _method =
          _this.data("ajax-method") || $.SOW.core.ajax_content.config.method,
      ...
      if (jQuery(_btn_reload).length > 0) {
        var _btnReloadTarget =
          jQuery(_btn_reload).attr("data-ajax-container") || "";

        if (_btnReloadTarget == "")
          jQuery(_btn_reload)
            .attr("data-ajax-container", "#" + _id)
      ...
      // Process!
      $.SOW.core.ajax_content.__ajaxDivProcess(
        _id,
        _url,
        _target,
        _method,
        ...
        .on("click", function (e) {
          ...
          if (__containerID != "") {
            var __t = jQuery(__containerID),
              ...
              __callback =
                __t.data("ajax-callback-function") ||
                $.SOW.core.ajax_content.config.callback_function,
              __callbackBeforePush =
                __t.data("ajax-callback-before-push") ||
                $.SOW.core.ajax_content.config.callback_before_push,
              __method =
                __t.data("ajax-method") ||
                $.SOW.core.ajax_content.config.method,
    ...
    __ajaxDivProcess: function (
      ...
      jQuery.ajax({
        ...
        beforeSend: function () {
          ...
          if (_btnEl) {
            jQuery(_target).addClass(
              "overlay-light overlay-opacity-6 overlay-over"
            );
            $.SOW.helper.loadingSpinner("show", _target);
        ...
        success: function (data) {
          ...
          if (
            _callback != "" &&
            typeof $.SOW.helper.executeFunctionByName === "function"
          )
            $.SOW.helper.executeFunctionByName(
              _callback,
              window,
					...
					<form class="js-ajax bs-validate" novalidate action="YOUR_URL" data-ajax-container="#ajax_container" data-ajax-update-url="true">
						...
						<!--
							...
							Instead of this alert, you can use a toast alert instead by adding to form:
								data-error-toast-text="<i class='fa fa-circle-spin fi-spin float-start'></i> Please, complete all required fields!"
								data-error-toast-delay="3000"
								data-error-toast-position="top-right"

						-->
						<div class="bs-validate-info hide alert alert-danger" data-error-alert-delay="4000">
							<i class="fa fa-circle-spin fi-spin float-start"></i>
    ...
    process: function (_this) {
      ...
      _this.submit(function (e) {
        var _t = _this,
          ...
          _controlUnexpected =
            _t.attr("data-ajax-control-alert-unexpected") || "",
          _controlMandatory =
            _t.attr("data-ajax-control-alert-mandaroty") || "",
          ...
          _modalCloseOnSuccess =
            _t.data("modal-autoclose-on-success") || "false",
          _modalCloseOnSuccessDelay =
            _t.data("modal-autoclose-on-success-delay") || 0;

        if (_onSucessShow != "" || _onErrorShow != "") {
          if (_target == "#middle") _target = "";
        }
        ...
        if (_t.hasClass("bs-validate")) {
          ...
          if (_form.checkValidity() === false) {
            ...
            if (_toast_text != "") {
              ...
              var _delay =
                jQuery(".bs-validate-info", _t).data("error-alert-delay") ||
                3000;
            ...
            if (
              typeof $.SOW.helper.scrollAnimate === "function" &&
              _scrollErrUp == "true" &&
              !jQuery(".modal").hasClass("show")
            ) {
              var _formEl = jQuery(
          ...
          // Stop here!
          if (window.ajax_form_stop === true) return;
        } else {
          if (_form.checkValidity() === false) {
            e.preventDefault();
            e.stopPropagation();
        ...
        if (_method.toLowerCase() == "post") {
          ...
          var __contentType =
            _contentType || $.SOW.core.ajax_form.config.contentType;
          ...
          success: function (data) {
            ...
            if (_controlAlerts + "" == "true") {
              ...
              if (hasErrors === true) {
                ...
                if ($.SOW.config.sow__debug_enable === true)
                  jQuery(_target).empty().html(data);
                else jQuery(_target).empty().html("Server Error!");
            ...
            if (_callback == "") {
              ...
              if (_target != "") jQuery(_target).empty().html(data);
    ...
    process: function (_this) {
      ...
      if (populate_form != "") {
        _this
          ...
          .on("change", function () {
            var _method =
                _this.data("ajax-method") ||
                $.SOW.core.ajax_select.config.method,
              _url = _this.data("ajax-url") || "",
            ...
            if (_thisVal == "") {
              ...
              jQuery("input[type=checkbox]", populate_form).prop(
                "checked",
                false
              );
              ...
              if (
                typeof $.SOW.vendor.bootstrap_select === "object" &&
                _this.hasClass("bs-select")
              )
            ...
            jQuery.ajax({
              ...
              success: function (data) {
                ...
                if (typeof data !== "object") {
                  $.SOW.helper.consoleLog("----------------------------");
                  $.SOW.helper.consoleLog(
                    "Select Form Populate : Not JSON! Aborting..."
                  );
                  $.SOW.helper.consoleLog("----------------------------");
                  return;
                }
                ...
                for (var i = 0; i < data.length; i++) {
                  for (var key in data[i]) {
                    ...
                    if (_el.length < 1) var _el = $(populate_form + " ." + key);
                    if (_el.length < 1) continue;

                    // file : skip
                    if (_el.attr("type") == "file") continue;

                    // checkbox & radio
                    if (
                      _el.attr("type") == "checkbox" ||
                      _el.attr("type") == "radio"
                    )
                      if (data[i][key] > 0 || data[i][key] == true) {
                        _el.prop("checked", true);
                      } else {
                        _el.prop("checked", false);
                      }
                    // input
                    else if (_el.is("input")) _el.val(data[i][key]);
                    // textarea
                    else if (_el.is("textarea")) _el.val(data[i][key]);
                    // select
      ...
      if (self_populate_url != "") {
        var _method =
            _this.data("ajax-method") || $.SOW.core.ajax_select.config.method,
          _params = _this.data("ajax-params") || "",
          _callback =
            _this.data("ajax-callback-function") ||
            $.SOW.core.ajax_select.config.callback_function,
          data_params = $.SOW.core.ajax_select.config.data_params,
          _val = "",
          _label = ":on_load:";
        ...
        $.SOW.core.ajax_select.ajax_process(
          self_populate_url,
          _method,
          data_params,
          _this,
      ...
      _this
        ...
        .on("change", function () {
          var _t = jQuery(this),
            ...
            _callback =
              _t.data("ajax-callback-function") ||
              $.SOW.core.ajax_select.config.callback_function,
          ...
          _t.children("option").each(function () {
            ...
            if (__t != "") jQuery(__t).addClass("hide hide-force");
          });
      ...
      jQuery.ajax({
        ...
        success: function (data) {
          ...
          if (_data.length > 0) {
            // Walk through json data
            for (var i = 0; i < _data.length; i++) {
              if (typeof _data[i]["label"] === "undefined") continue;

              if (typeof _data[i]["value"] === "undefined")
                _data[i]["value"] = "";

              if (_data[i]["label"] == "" && _data[i]["value"] == "") continue;
              ...
              // selected
              if (
                typeof _data[i]["selected"] !== "undefined" &&
              ...
              if (typeof _data[i]["show_container"] !== "undefined") {
                jQuery(o).attr(
                  "data-show-container",
                  _data[i]["show_container"]
                );

                if (process_recursive_selected == _data[i]["value"])
                  jQuery(_data[i]["show_container"]).removeClass(
                    "hide hide-force"
                  );
              }
              ...
              if (_data[i]["selected"] && _data[i]["selected"] === true) {
                ...
                if (process_type === "self") var process_recursive = true;
              }
            }
          } else {
            // set disabled
          ...
          setTimeout(function () {
            ...
            if (_callback != "" && typeof _callback !== "undefined")
              $.SOW.core.ajax_select.ajax_callback(
                _callback,
                _t,
                selected_val,
                selected_label
...
(function ($) {
  ...
  $.SOW.core.ajax_modal = {
      ...
      _this
        ...
        .on("click", function (e) {
          ...
          var _t = jQuery(this),
            ...
            _modal_callback =
              _t.data("ajax-modal-callback-function") || _callback, // callback function to call, on modal load
          ...
          // Ignore by request!
          if (_t.hasClass("js-ignore")) return;

          /*
					Empty ajax modal on close
					else, plugins like selectpicker will not refresh
				*/ jQuery(
            _target + " .modal-content"
          ).empty();

          // Close any open dropdown
          jQuery(".dropdown-menu:not(.dropdown-menu-hover)")
            .parent()
            .find('a[data-toggle="dropdown"][aria-expanded="true"]')
            .attr("aria-expanded", "false")
            .dropdown("hide");

          // Call the trigger
          $.SOW.core.ajax_modal.modalAjaxShow(
            _href,
            _target,
            _modal_size,
            _modal_centered,
    ...
    modalAjaxShow: function (
      ...
      var _modal_size =
        typeof _modal_size !== "undefined"
          ? _modal_size
          : this.config.modal_size;
      var _modal_centered =
        typeof _modal_centered !== "undefined"
          ? _modal_centered
          : this.config.modal_centered;
      var _modal_backgdrop =
        typeof _modal_backgdrop !== "undefined" ? _modal_backgdrop : "";
      var _modal_callback =
        typeof _modal_callback !== "undefined" ? _modal_callback : "";
      ...
      jQuery(".modal-dialog", _target).removeClass(
        "modal-dialog-centered modal-sm modal-lg modal-xl modal-full"
      );
      ...
      if (_modalType.toLowerCase() + "" == "video") {
        ...
        // load modal
        var _loader =
          '<div class="text-center p-6 fs--30 text-muted ' +
          $.SOW.config.sow__icon_loading +
          '"></div>';
        jQuery(_target)
          .modal("dispose")
          .modal({ backdrop: _backdrop, keyboard: _keyboard })
          .find(".modal-content")
          .html(_loader);
        ...
        setTimeout(function () {
          jQuery(_target)
            ...
            .html(embedData)
            .addClass(
              "rounded-xl bg-dark shadow-primary-xs border border-dark bw--3"
            )
            .prepend(
              '<button type="button" class="close pointer position-absolute top-0 end-0 mt--n50 mx-1 text-white z-index-100" data-dismiss="modal" aria-label="Close"><span class="fa fa-close fs--25" aria-hidden="true"></span></button>'
            );

          // try another way to start the video! AdBlock is problematic!
          jQuery("iframe", _target).attr(
            "src",
            jQuery("iframe", _target).data("autoplay-src")
          );
        }, 450);
    ...
    ajax_modal_template: function () {
      if (jQuery(this.config.modal_container).length > 0) return;
    ...
    createFromThinAir: function (
      ...
      if (!url)
        $.SOW.helper.consoleLog(
          "SOW Ajax Modal : [createFromThinAir()] : No url provided!"
        );
      ...
      $.SOW.globals.elBody.append(
        '<a id="ajax_modal_create_tmp" href="' +
          url +
          '" class="hide ' +
          selectorClass +
          '"></a>'
    ...
    attach: function (href, delay) {
      ...
      // unbind
      if (el.hasClass("js-modalified")) el.off().removeClass("js-modalified");
...
(function ($) {
  ...
  $.SOW.core.ajax_confirm = {
    ...
    config: {
      ...
      btn_text_no: "Cancel",
      btn_icon_yes: "fa fa-check",
      btn_icon_no: "fa fa-close",
    ...
    /**
		...
		<a href="URL-HERE"
			...
			data-ajax-confirm-btn-yes-icon="fa fa-check"

			data-ajax-confirm-btn-no-text="Cancel"
			data-ajax-confirm-btn-no-class="btn-sm btn-light"
			data-ajax-confirm-btn-no-icon="fa fa-close"
      ...
      _this
        ...
        .on("click", function (e) {
          ...
          var _t = jQuery(this),
            ...
            _modal_centered =
              _t.data("ajax-confirm-centered") || _confirm_centered, // true|false
            _confirmCallback =
              _t.data("ajax-confirm-callback-function") || _confirm_callback, // custom function
            ...
            _confirmSuccessElAction =
              _t.data("ajax-confirm-success-target-action") || "", // action: remove|addClass|removeClass|toggleClass
            _confirmSuccessElClass =
              _t.data("ajax-confirm-success-target-class") || "", // class to remove or add
            ...
            _confirmBtnYesTxt =
              _t.data("ajax-confirm-btn-yes-text") || btn_text_yes, // button text
            _confirmBtnYesClass =
              _t.data("ajax-confirm-btn-yes-class") || btn_class_yes, // button class
            _confirmBtnYesIcon =
              _t.data("ajax-confirm-btn-yes-icon") || btn_icon_yes, // button icon. eg: fa fa-check
            _confirmBtnNoTxt =
              _t.data("ajax-confirm-btn-no-text") || btn_text_no, // button text
            _confirmBtnNoClass =
              _t.data("ajax-confirm-btn-no-class") || btn_class_no, // button class
            _confirmBtnNoIcon =
              _t.data("ajax-confirm-btn-no-icon") || btn_icon_no; // button icon. eg: fa fa-check
          ...
          // Add size class by request
          jQuery(".modal-dialog", _target)
            .removeClass(
              "modal-sm, modal-md, modal-lg, modal-xlg, modal-full bg-primary-soft bg-secondary-soft bg-success-soft bg-warning-soft bg-danger-soft bg-pink-soft bg-indigo-soft bg-purple-soft"
            )
            .addClass(_modal_confirm_size);

          // Header Bg Color
          jQuery(".modal-header", _target).removeClass(
            "bg-primary-soft bg-secondary-soft bg-success-soft bg-warning-soft bg-danger-soft bg-info-soft bg-pink-soft bg-indigo-soft bg-purple-soft border-0"
          );
          if (_confirmType != "")
            jQuery(".modal-header", _target).addClass(
              "bg-" + _confirmType + "-soft border-0"
            );

          // centered
          _modal_centered + "" == "true"
            ? jQuery(".modal-dialog", _target).addClass("modal-dialog-centered")
            : jQuery(".modal-dialog", _target).removeClass(
          ...
          // Reset
          jQuery(".btn-confirm-yes", _target)
            .attr("class", "")
            .attr("class", "btn btn-confirm-yes");
          jQuery(".btn-confirm-no", _target)
            .attr("class", "")
            .attr("class", "btn btn-confirm-no");
          ...
          if (_confirmBtnYesIcon.length > 1)
            var _confirmBtnYesTxt =
              '<i class="' + _confirmBtnYesIcon + '"></i> ' + _confirmBtnYesTxt;

          if (_confirmBtnNoIcon.length > 1)
            var _confirmBtnNoTxt =
              '<i class="' + _confirmBtnNoIcon + '"></i> ' + _confirmBtnNoTxt;

          jQuery(".btn-confirm-yes", _target)
            .attr("href", _href)
            .html(_confirmBtnYesTxt)
            .addClass(_confirmBtnYesClass);
          jQuery(".btn-confirm-no", _target)
            .html(_confirmBtnNoTxt)
            .addClass(_confirmBtnNoClass);
              ...
              .on("click", function (e) {
                ...
                jQuery.ajax({
                  ...
                  success: function (data) {
                    ...
                    jQuery(_target + " .modal-content .modal-body").html(
                      '<div class="js-modal-confirm-ok pt--20 pb--30 text-center animate-bouncein"><i class="' +
                        $.SOW.config.sow__icon_check +
                        ' fs--40 text-muted"></i></div>'
                    );
                    jQuery(".btn-confirm-yes", _target)
                      .removeClass("disabled")
                      .prop("disabled", false);
                    ...
                    if (_confirmSuccessEl != "") {
                      if (_confirmSuccessElAction == "remove")
                        ...
                        jQuery(_confirmSuccessEl).addClass(
                          _confirmSuccessElClass
                        );
                      else if (_confirmSuccessElAction == "removeClass")
                        jQuery(_confirmSuccessEl).removeClass(
                          _confirmSuccessElClass
                        );
                      else if (_confirmSuccessElAction == "toggleClass")
                        jQuery(_confirmSuccessEl).toggleClass(
                          _confirmSuccessElClass
                        );
                    }
                  },
    ...
    ajax_confirm_template: function () {
      ...
      var confirm_container = this.config.confirm_container.replace("#", ""),
        _tpl =
          '<div class="modal fade" id="' +
          confirm_container +
          '" role="dialog" tabindex="-1" aria-labelledby="modal-title-confirm" aria-hidden="true">' +
          '<div class="modal-dialog ' +
          ...
          '<span class="fa fa-close fs--18" aria-hidden="true"></span>' +
          "</button>" +
          "</div>" +
          ...
          '<a href="#" class="btn pt--10 pb--10 fs--16 btn-confirm-yes ' +
          this.config.btn_class_yes +
          '">' +
          this.config.btn_text_yes +
          "</a>" +
          '<a href="#" class="btn pt--10 pb--10 fs--16 btn-confirm-no ' +
...
(function ($) {
  ...
  $.SOW.core.file_upload = {
    ...
    init: function (selector, config) {
      ...
      // 1. Has no selector
      if (!this.selector) {
        $.SOW.core.file_upload.file_upload__init(
      ...
      jQuery(_this).each(function () {
        ...
        if (preview_delete != false) {
          if (is_multiple != false)
            $.SOW.core.file_upload.file_upload__preview_delbtn_bind_multiple(
              _t,
              true
            );

          if (is_multiple == false)
            $.SOW.core.file_upload.file_upload__preview_delbtn_bind_single(
              _t,
              true
            );
        }
      ...
      jQuery(_this)
        ...
        .on("change", function (e) {
          var _t = jQuery(this),
            ...
            file_name =
              is_multiple === false
                ? _t.get(0).files[0].name.replace("C:\\fakepath\\", " ")
                : "",
            label_orig = _t.next(".custom-file-label").attr("data-orig") || "",
            exts_allowed = _t.data("file-ext") || "",
            exist_error_txt =
              _t.data("file-exist-err-msg") || "File already exist: ",
            exts_error_txt = _t.data("file-ext-err-msg") || "Allowed: ",
            size_error_txt =
              _t.data("file-size-err-item-msg") || "File too large! ",
            size_error_txt_total =
              _t.data("file-size-err-total-msg") || "Total size exceeded!",
            selected_txt = _t.data("file-size-err-total-msg") || "selected", // in case preview is not used
            max_error_txt_total =
              _t.data("file-size-err-max-msg") || "Maximum allowed files:",
            ...
            btn_clear_files =
              _t.data("file-btn-clear") ||
              "a.js-advanced-form-input-clone-clear",
          ...
          if (preview_list_type == "list") preview_as_cover = true;
          ...
          if (is_multiple === false)
            ...
            _t.next(".custom-file-label").text(
              _t.get(0).files.length + " " + selected_txt
            ); // in case preview is not used
          ...
          for (var i = 0; i < total_files; ++i) {
            var file = _t.get(0).files[i],
              ...
              file_img =
                '<div class="js-advanced-form-default-preview absolute-full d-table w-100 h--120"><div class="d-table-cell align-middle text-center"><span class="fs--30 text-gray-500">?</span></div></div>',
            ...
            /*
					...
					*/
            if (max_files > 0) {
              var total_files_current = jQuery(
                ".js-file-input-item",
                preview_container
              ).length;
              ...
              if (parseInt(total_files_current) >= max_files) {
                ...
                $.SOW.core.file_upload.file_upload__del_bulk(
                  _t,
                  _bulkNo,
                  btn_clear_files,
                  preview_container,
            ...
            if (max_size_total > 0) {
              ...
              var filesSizeBulk_current =
                file_size_kb_bulk + window.filesSizeBulk;

              if (parseInt(filesSizeBulk_current) > parseInt(max_size_total)) {
                var _msg =
                  size_error_txt_total + " <hr>(" + max_size_total + "kb)";
            ...
            /*
					...
					*/
            if (
              window.fileInventory[fileInputIdentifier].indexOf(_concat) !== -1
            ) {
              if (typeof $.SOW.core.toast === "object")
                $.SOW.core.toast.show(
                  "danger",
                  "",
                  exist_error_txt + "<br> " + file.name,
                  toast_position,
                  4500,
                  true
                );
            ...
            if (preview_container != "") {
              var _tpl = $.SOW.core.file_upload.file_upload__preview_tpl(
                file,
                file_ext,
                _rand,
                _bulkNo,
              ...
              if (ajax_process_enable === true) {
                ...
                if (preview_reorder === true)
                  $.SOW.core.file_upload.file_upload__preview__reorder_bind(
                    _t,
                    false
                  );
              }
              ...
              if (
                ...
                $.SOW.core.file_upload.file_upload__preview_img_render(
                  "#" + _rand,
                  file,
                  preview_as_cover,
                  preview_list_type
          ...
          $.SOW.core.file_upload.file_upload__btn_clear_bind(
            btn_clear_files,
            _t,
            preview_container,
            input_name,
          ...
          if (window.browser_hasIssues !== true && is_multiple !== false) {
            ...
            if (
              jQuery("#js_advanced_form_identifier_" + fileInputIdentifier)
                .length < 1
            ) {
              var __el = _t.next();

              // If input is inside a <label>
              if (_t.parents("label").length > 0) __el = _t.parents("label");
              ...
              if (_t.parent("form").length > 0) __el = _t;

              __el.after(
                '<div id="js_advanced_form_identifier_' +
                  fileInputIdentifier +
                  '" class="viewport-out w--50 h--50 opacity-0"></div>'
              );
            }

            jQuery(
              "#js_advanced_form_identifier_" + fileInputIdentifier
            ).append(_clone);
          ...
          if (ajax_process_enable === true) {
            ...
            setTimeout(function () {
              ...
              $.SOW.core.file_upload.file_upload__ajax_upload(
                fileInputIdentifier,
                _bulkNo
              );
            }, 350);
    ...
    file_upload__reset: function (
      ...
      // set back "Choose file" label
      var label_orig =
        _t.next(".custom-file-label").attr("data-orig") || "Choose file";
      _t.next(".custom-file-label").html(label_orig);
    ...
    file_upload__clear: function (fileInputIdentifier) {
      jQuery(
        'input[type="file"][data-js-advanced-identifier="' +
          fileInputIdentifier +
          '"]'
      )
        .val("")
    ...
    file_upload__preview_tpl: function (
      file,
      file_ext,
      item_unique_id,
      _bulkNo,
      ...
      var _loadingIcon =
        '<i class="' + $.SOW.config.sow__icon_loading + ' fs--30"></i>';
      var _loadingIconSize = preview_list_type == "list" ? "fs--20" : "fs--30";

      // default preview class
      if (preview_class == "")
        var preview_class =
          preview_list_type == "list"
            ? "show-hover-container shadow-md mb-2 rounded"
            : "show-hover-container shadow-md m-2 rounded";
      ...
      if (
        ...
        file_img +=
          '<img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" alt="" class="hide animate-bouncein js-file-input-preview mw-100 ' +
          img_fluid +
          '" height="' +
          h +
          '">';
        ...
        var file_ext_font_size =
          preview_list_type == "list" ? "fs--18" : file_ext_font_size;
        var file_img =
          '<span class="absolute-full d-flex align-items-center justify-content-center ' +
          file_ext_font_size +
          ' opacity-6 text-uppercase text-truncate">' +
          file_ext +
          "</span>";
      }
      ...
      if (preview_list_type == "list") {
        var _tpl =
          ...
          _bulkNo +
          " d-flex clearfix position-relative " +
          preview_class +
          '">';
        ...
        _tpl +=
          '<div class="position-relative d-inline-block bg-cover" style="width:' +
          h +
          "px; min-width:" +
          h +
          "px; height:" +
        ...
        _tpl +=
          '<div class="pl--15 pr--15 flex-fill d-flex min-w-0 align-items-center">';

        // file name
        _tpl +=
          '<span class="text-truncate d-block line-height-1">' + file.name;

        // file size
        if (preview_info != false)
          _tpl +=
            '<br><span class="fs--12 d-block pt-1">' + human_size + "</span>";
      ...
      if (ajax_process_enable === true) {
        ...
        // ajax loading
        _tpl +=
          '<span class="hide hide-force js-file-input-preview-ajax-uploading absolute-full d-flex align-items-center justify-content-center overlay-light overlay-opacity-8 z-index-3">' +
          _loadingIcon +
          "</span>";
      }
    ...
    file_upload__preview_img_render: function (
      id,
      file,
      preview_as_cover,
      preview_list_type
      ...
      reader.onload = function (s) {
        ...
        if (preview_as_cover !== false) {
          ...
          jQuery(__id)
            .css("background-image", "url(" + s.target.result + ")")
            .addClass("bg-cover")
            .removeClass("hide");
        } else {
          jQuery(id + " img.js-file-input-preview")
    ...
    file_upload__del_bulk: function (
      _t,
      _bulkNo,
      btn_clear_files,
      preview_container,
      ...
      for (var b = 0; b < window.filesLastBulk.length; ++b) {
        ...
        if (_remains < 1)
          $.SOW.core.file_upload.file_upload__reset(
            _t,
            btn_clear_files,
            preview_container,
            input_name,
    ...
    file_upload__preview_delbtn_bind_multiple: function (
      _t,
      request_from_preadded
    ) {
      var fileInputIdentifier = _t.attr("data-js-advanced-identifier") || "",
        ...
        ajax_url =
          _t.attr("data-file-ajax-delete-url") ||
          _t.attr("data-file-ajax-upload-url"),
        ajax_params = _t.attr("data-file-ajax-delete-params") || "",
        delToastTxt =
          _t.attr("data-file-ajax-delete-toast-txt") || "Successfully Deleted!",
        delToastPos =
          _t.attr("data-file-ajax-delete-toast-position") ||
          $.SOW.core.file_upload.config.toast_pos,
        is_multiple = _t.attr("multiple") || false,
        preview_height = _t.attr("data-file-preview-img-height") || "120";

      if (preview_container == "" || is_multiple == false) return;
      ...
      if (request_from_preadded === true) {
        jQuery(preview_container + " .js-file-input-item").each(function () {
          ...
          jQuery("a.js-file-item-del", elItemPreadded).attr(
            "data-item-id",
            _preaddedItemId
          ); // DOM item id
        });
      ...
      $.SOW.core.file_upload.file_upload__preview_item_del_ajax(
        fileInputIdentifier,
        btn_file_del,
        ajax_params,
        ajax_url,
    ...
    file_upload__preview_delbtn_bind_single: function (
      _t,
      request_from_preadded
    ) {
      var fileInputIdentifier = _t.attr("data-js-advanced-identifier") || "",
      ...
      if (elItemPreadded.length < 1) return;
    ...
    file_upload__preview_item_del_ajax: function (
      fileInputIdentifier,
      btn_file_del,
      ajax_params,
      ajax_url,
      ...
      jQuery(btn_file_del)
        ...
        .on("click", function (e) {
          ...
          if (fileName == "" && item_id == "") {
            ...
            $.SOW.helper.consoleLog(
              "Please provide: data-id  -OR-  data-file-name "
            );
            return;
          }
          ...
          formDataDel.append(
            "__info",
            "`file_id` = internal/database file id. 0 = not provided!"
          );
          ...
          $.ajax({
            ...
            success: function (data) {
              ...
              if (item_id != "") jQuery("#" + item_id).remove();

              // remove from inventory, or the file could not be added again
              if (fileSize != "") {
                var _concat =
                  fileName + ":" + fileSize + ":" + fileInputIdentifier;
                for (var inventoryIndex in window.fileInventory[
                  fileInputIdentifier
                ]) {
                  if (
                    window.fileInventory[fileInputIdentifier][inventoryIndex] ==
                    _concat
                  ) {
                    window.fileInventory[fileInputIdentifier].splice(
                      inventoryIndex,
                      1
                    );
                    break;
    ...
    file_upload__preview__reorder_bind: function (_t, request_from_preadded) {
      ...
      if (typeof $.SOW.vendor.sortable !== "object") {
        $.SOW.helper.consoleLog(
          "Ajax Image Reorder : Require Sortablejs Vendor!"
        );
        return;
      } else {
        ...
        if (typeof Sortable !== "function") {
          ...
          if ($.SOW.config.autoinit["sortable"]) {
            ...
            jQuery("#middle").append(
              '<span class="hide ' + _class + '"></span>'
            );
      ...
      var fileInputIdentifier = _t.attr("data-js-advanced-identifier") || "",
        ...
        preview_container = _t.attr("data-file-preview-container") || "",
        ajax_url =
          _t.attr("data-file-ajax-reorder-url") ||
          _t.attr("data-file-ajax-upload-url"),
        ajax_params = _t.attr("data-file-ajax-reorder-params") || "",
        reorder_toast_success =
          _t.attr("data-file-ajax-reorder-toast-success") || "",
        reorder_toast_position =
          _t.attr("data-file-ajax-reorder-toast-position") || "",
      ...
      if (preview_container == "") return;
        ...
        jQuery(preview_container + " .js-file-input-item").removeAttr(
          "draggable"
        );
      ...
      jQuery(">:not(.js-file-input-item)", preview_container).addClass(
        "js-ignore"
      );
      ...
      jQuery(preview_container).attr(
        "data-ajax-update-identifier",
        fileInputName.replace("[]", "")
      );

      if (reorder_toast_success != "")
        jQuery(preview_container).attr(
          "data-update-toast-success",
          reorder_toast_success
        );

      if (reorder_toast_position != "")
        jQuery(preview_container).attr(
          "data-update-toast-position",
          reorder_toast_position
        );
    ...
    file_upload__btn_clear_bind: function (
      btn_clear_files,
      _t,
      preview_container,
      input_name,
    ...
    file_upload__ajax_upload: function (fileInputIdentifier, _bulkNo) {
      if (_bulkNo == "" && fileInputIdentifier == "") {
        $.SOW.helper.consoleLog(
          "Ajax Image Upload Status : Identifiers missing!"
        );
        return;
      }
      ...
      var fileInventory = [],
        ...
        progressDisabled =
          elFileInput.data("file-ajax-progressbar-disable") || false,
        toast_position =
          elFileInput.data("file-toast-position") ||
          $.SOW.core.file_upload.config.toast_pos;
      ...
      if (ajax_url == "") {
        $.SOW.helper.consoleLog(
          "Ajax Image Upload Status : [data-file-ajax-upload-url] : Missing -or- Empty!"
        );
        return;
      }
      ...
      if (fileInventory.length < 1) {
        $.SOW.helper.consoleLog(
          "Ajax Image Upload Status : No file found to upload!"
        );
        return;
      }
      ...
      $.ajax({
        ...
        beforeSend: function () {
          jQuery(
            ".js-file-input-item." +
              _bulkNo +
              " .js-file-input-preview-ajax-uploading"
          ...
          elFileInput
            .parent()
            .find(".js-file-input-ajax-loader")
            .removeClass("hide hide-force");

          // Create progress bar
          $.SOW.core.file_upload.file_upload__ajax_upload_progressbar_init(
            elFileInput
          );
        },
        ...
        success: function (data) {
          ...
          elFileInput
            .parent()
            .find(".js-file-input-ajax-loader")
            .addClass("hide hide-force");

          jQuery(
            ".js-file-input-item." +
              _bulkNo +
              " .js-file-input-preview-ajax-uploading i"
          ).replaceWith(
            '<i class="' +
              $.SOW.config.sow__icon_check +
              ' fs--20 pt--5 text-success w--40 h--40 d-inline-block text-center bg-success-soft rounded-circle opacity-8 animate-bouncein"></i>'
          );
          setTimeout(function () {
            jQuery(
              ".js-file-input-item." +
          ...
          if (
            ...
            $.SOW.helper.executeFunctionByName(
              ...
              data,
              elFileInput
            ); // input element is returned because of safari issues (bulk is empty)

          // Destroy progress bar
          $.SOW.core.file_upload.file_upload__ajax_upload_progressbar_destroy(
            elFileInput,
            false
          );

          // Disable input
          if (is_multiple === false) elFileInput.prop("disabled", true); // var data = {"file_list":{"orig_file_name_1.jpg":1,"orig_file_name_2.jpg":345},"something_else":[]}
          ...
          if (_json != "") {
            if (typeof _json["file_list"] !== "undefined") {
              for (var fileName in _json["file_list"]) {
                jQuery(
                  preview_container +
                    ' .js-file-input-item[data-file-name="' +
                    fileName +
                    '"]'
                ).attr("data-id", _json["file_list"][fileName]);
              }
            }

            // Bind reorder
            $.SOW.core.file_upload.file_upload__preview__reorder_bind(
              jQuery(preview_container),
              true
            );
          }
          ...
          __xhr.upload.addEventListener(
            ...
            function (e) {
              if (e.lengthComputable && progressDisabled == false) {
                ...
                $(
                  ".js_file_input_progress__" +
                    fileInputIdentifier +
                    " .js-file-input-upload-percent"
                ).text(___percent + "%");
                $(
                  ".js_file_input_progress__" +
                    fileInputIdentifier +
                    " .progress-bar"
                ).css("width", ___percent + "%");
                $(
                  ".js_file_input_progress__" +
                    fileInputIdentifier +
                    " .progress-bar"
                ).attr("aria-valuenow", ___percent);
                ...
                if (___percent >= 100) {
                  ...
                  $(
                    ".js_file_input_progress__" +
                      fileInputIdentifier +
                      " .js-file-input-upload-percent.js-file-input-upload-percent-dynamic"
                  ).prepend(
                    '<i class="' +
                      $.SOW.config.sow__icon_check +
                      ' fs--10 animate-bouncein"></i> &nbsp; '
                  );
                  ...
                  $(
                    ".js_file_input_progress__" +
                      ...
                      ", .js_file_input_progress__" +
                      fileInputIdentifier +
                      " .js-file-input-upload-percent:not(.js-file-input-upload-percent-dynamic) .group-icon"
                  ).addClass("active");
                }
              }
            },
    ...
    file_upload__ajax_upload_progressbar_init: function (elFileInput) {
      if (elFileInput.length < 1) return;

      var fileInputIdentifier =
          elFileInput.data("js-advanced-identifier") || "",
        customProgress = elFileInput.data("file-ajax-progressbar-custom") || "",
        progressDisabled =
          elFileInput.data("file-ajax-progressbar-disable") || false,
        __next = elFileInput.next();

      if (fileInputIdentifier == "" || progressDisabled != false) return;
      ...
      if (jQuery(customProgress).length > 0) {
        ...
        if (
          !elCustomProgress.hasClass(
            "js_file_input_progress__" + fileInputIdentifier
          )
        )
          elCustomProgress.addClass(
            "js_file_input_progress__" + fileInputIdentifier
          );
      ...
      var _tpl =
        ...
        fileInputIdentifier +
        ' animate-bouncein transition-all-ease-500 position-absolute w-100 mb--n5 bottom-0 left-0 right-0 h--3">' +
    ...
    file_upload__ajax_upload_progressbar_destroy: function (
      elFileInput,
      elDestroyForReal
    ) {
      if (elFileInput.length < 1) return;
      ...
      // Whooo!
      setTimeout(function () {
        jQuery(".js_file_input_progress__" + fileInputIdentifier)
          .not(".js-ignore")
          .fadeOut(800, function () {
            /*
						...
						*/
            if (elDestroyForReal === true) jQuery(this).remove();
          });
      }, 1000);
    },
    ...
    file_upload__destroy: function (container) {
      ...
      jQuery(
        container + " " + $.SOW.core.file_upload.config.selector_advanced_file
      ).each(function () {
        var _t = jQuery(this),
...
(function ($) {
  ...
  $.SOW.core.toast = {
    ...
    show: function (t_type, t_title, t_body, t_pos, t_delay, t_bg_fill) {
      ...
      if (t_type == "error") var t_type = "danger";
      else if (t_type == "default") var t_type = "";
      ...
      var t_delay_bs =
        t_delay > 0
          ? ' data-delay="' + t_delay + '" data-autohide="true"'
          : ' data-autohide="false" ';
      ...
      if (t_delay > 0) {
        ...
        var t_close =
          ...
          _btnCloseClass +
          '" data-dismiss="toast" aria-label="Close"><span class="fa fa-close fs--16" aria-hidden="true"></span></button>';
        var t_progress = "";
      }
      ...
      if (jQuery("#" + _wrapperID).length < 1)
        $.SOW.globals.elBody.append(
          '<div id="' +
            _wrapperID +
            '" class="w-100 max-w-300 max-h-75vh scrollable-vertical rounded z-index-9999 ' +
            _posClass +
            '"></div>'
        );
      ...
      // BUILD HTML TOAST
      var t_main_class =
        t_bg_fill === true && t_type != "" ? "b-0 bg-" + t_type : "bg-white";
      var _toastBody =
        '<div class="toast js-toast ' +
        $.SOW.core.toast.config.animation +
        " " +
        t_main_class +
        " " +
        t_spacing +
      ...
      if (t_title != "") {
        ...
        var t_header_class =
          t_bg_fill === true && t_type != ""
            ? " bg-transparent overlay-dark overlay-opacity-1 text-white"
            : "";
      ...
      if (t_title == "") {
        ...
        var t_body =
          '<div class="py-3 ' + t_txt_color + '">' + t_body + "</div>";
      } else {
        var t_body =
          t_bg_fill === true && t_type != ""
            ? '<div class="pt--5 pb--10 text-white">' + t_body + "</div>"
            : t_body;
      }
      ...
      if (t_delay > 0)
        jQuery(
          "#" +
            _wrapperID +
            " .js-toast:not(.hide):first-child .progress>.progress-bar"
        )
          .filter(":not(:animated)")
          .stop()
          .animate({ width: "100%" }, 0)
          .stop()
          .animate({ width: "0%" }, t_delay);
    ...
    destroy: function () {
      jQuery(
        "#wrapper_toast_tr, #wrapper_toast_br, wrapper_toast_tl, #wrapper_toast_bl, #wrapper_toast_tc, #wrapper_toast_bc"
      ).remove();
    },
  };
})(jQuery);
...
(function ($) {
  ...
  $.SOW.core.dropdown_click_ignore = {
    ...
    init: function (selector, config) {
      ...
      $.SOW.core.dropdown_click_ignore.stop_dd_empty_link(
        $(".dropdown-menu a")
      );
      ...
      // 1. Has no selector
      if (!this.selector) {
        $.SOW.core.dropdown_click_ignore.process(
          $(".dropdown-menu.dropdown-click-ignore")
        );
    ...
    stop_dd_empty_link: function (_this) {
      _this.not('[data-toggle="collapse"]').on("click", function (e) {
        ...
        if (_href == "#" && !_t.hasClass("js-ignore")) e.preventDefault();
      });
    },
    ...
    stopPropagationOnHoverEnbaled: function () {
      // Nothing to do!
      if ($.SOW.globals.is_mobile === true) return null;
      ...
      jQuery('a[data-toggle="dropdown"]')
        ...
        .on("click", function (e) {
          ...
          if (_hrefValid === true) return false;

          // stop bootstrap to act!
          if (
            _t.next().closest(".dropdown-menu").hasClass("dropdown-menu-hover")
          ) {
            e.preventDefault();
            e.stopPropagation();
          }
  ...
  $.SOW.core.dropdown = {
    ...
    init: function (selector, config) {
      ...
      if (typeof $.SOW.core.dropdown_click_ignore !== "object")
        $.SOW.helper.consoleLog(
          "[sow.dropdown] Missing [sow.dropdown_click_ignore]"
        );
    ...
    onClickUpdateText: function () {
      jQuery(
        ".dropdown-menu-click-update a.dropdown-item, .dropdown-menu-click-update a.dropdown-link"
      )
        ...
        .on("click", function (e) {
          ...
          jQuery(
            "a.dropdown-item, a.dropdown-link",
            dropdownContainer
          ).removeClass("active");
          _t.addClass("active");

          // find button trigger & update text
          var dropdownBtnTrigger = dropdownContainer
            .parent()
            .find('[data-toggle="dropdown"]');
          if (dropdownBtnTrigger) {
            var dropdownBtnTextToUpdate = jQuery(".js-trigger-text", _t).text();
            if (dropdownBtnTextToUpdate)
              jQuery(".js-trigger-text", dropdownBtnTrigger).text(
                dropdownBtnTextToUpdate
              );
          }
          ...
          setTimeout(function () {
            ...
            if (
              !dropdownContainer.hasClass("dropdown-click-ignore") &&
              dropdownContainer.hasClass("show")
            )
              dropdownContainer.dropdown("hide");

            // Callback
            var callBack =
              dropdownContainer.attr("data-dropdown-callback") || "";
            if (callBack != "") {
    ...
    forceCloseDropdown: function (_t) {
      // Object required
      if (typeof _t !== "object") return null;
      // Search for ignore class
      else if (_t.hasClass("js-ignore") || _t.hasClass("js-ignore-close"))
        return null;
      // Search for a dropdown link
      else if (
        !_t.hasClass("dropdown-link") &&
        !_t.hasClass("dropdown-item") &&
        !_t.hasClass("dropdown-menu")
      )
        return null;
      ...
      // Nothing found!
      if (!__dropdownContainer) return null;
...
(function ($) {
  ...
  $.SOW.core.dropdown_ajax = {
    ...
    config: {
      // general
      loading_icon: "fa fa-circle-spin fi-spin",
    ...
    process: function (_this) {
      // Required
      if (_this.data("dropdown-ajax-source") == "") return;
      ...
      if ($.SOW.globals.is_mobile === true) {
        ...
        if (
          _this.next().closest(".dropdown-menu").hasClass("dropdown-menu-hover")
        )
      ...
      _this.on(jQ_actions, function (e) {
        var _t = jQuery(this),
          ...
          _clearCacheInterval =
            _t.data("dropdown-ajax-refresh-interval") ||
            $.SOW.core.dropdown_ajax.config.clearCacheInterval,
          _reloadAlways = _t.data("dropdown-ajax-reload-always") || false,
          _loadIcon =
            _t.data("dropdown-ajax-loadicon") ||
            $.SOW.core.dropdown_ajax.config.loading_icon,
        ...
        if (_reloadAlways == false && _clearCacheInterval > 0)
          $.SOW.core.dropdown_ajax.process_clearCacheInterval(
            _t,
            _containerID,
            _clearCacheInterval
          );
        ...
        if (_reloadAlways == false && _t.hasClass("js-dropdownified")) return;
        ...
        jQuery.ajax({
          ...
          beforeSend: function () {
            _container.html(
              '<div class="js-dd-ajax-loader text-center rounded p-3"><i class="' +
                _loadIcon +
                ' h5 text-gray-400"></i></div>'
            );
          },
    ...
    process_json_build_tree: function (data) {
      ...
      if (typeof data === "undefined") return _tpl;

      for (var i = 0; i < data.length; i++) {
        /* 0. Divider -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- */
        if (
          typeof data[i].divider !== "undefined" &&
          data[i].divider === true
        ) {
          ...
          /* 1. Text -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- */
          typeof data[i].text !== "undefined" &&
          data[i].text.length > 0
        ) {
          _tpl +=
            $.SOW.core.dropdown_ajax.config.tpl_ItemStart +
            data[i].text +
            $.SOW.core.dropdown_ajax.config.tpl_ItemEnd;
          continue;
        }
        /* -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- */

        var has_childs =
          typeof data[i].childs !== "undefined" && data[i].childs.length > 0
            ? true
            : false;
        ...
        _tpl +=
          has_childs === true
            ? $.SOW.core.dropdown_ajax.config.tpl_ItemStartWChilds
            : $.SOW.core.dropdown_ajax.config.tpl_ItemStart;
        /* -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- */
        ...
        var _class =
          typeof data[i].class !== "undefined" && data[i].class != ""
            ? " " + data[i].class
            : "";
        _class +=
          typeof data[i].active !== "undefined" && data[i].active == true
            ? " active"
            : "";
        _class +=
          typeof data[i].disabled !== "undefined" && data[i].disabled == true
            ? " disabled"
            : "";

        var _icon =
          typeof data[i].icon !== "undefined" && data[i].icon != ""
            ? '<i class="' + data[i].icon + '"></i>'
            : "";
        var _target =
          typeof data[i].target !== "undefined" && data[i].target != ""
        ...
        if (has_childs === true) {
          ...
          _tpl += $.SOW.core.dropdown_ajax.process_json_build_tree(
            data[i].childs
          );
          _tpl += $.SOW.core.dropdown_ajax.config.tpl_end;
        }
     ...
     *
     **/
    process_clearCacheInterval: function (
      _t,
      _containerID,
      _clearCacheInterval
    ) {
      ...
      // Cache Refreshed & Content Reloaded
        ...
        timestampNow - ddTimeKepper[_containerID] >
        _clearCacheInterval
      ) {
        ddTimeKepper[_containerID] = timestampNow;
    ...
    addToCache: function (_URL, data) {
      ...
      var cachedDropdownsArr = cachedDropdowns
        ? JSON.parse(cachedDropdowns)
        : {};
      ...
      localStorage.setItem(
        "cachedDropdowns",
        JSON.stringify(cachedDropdownsArr)
      );
    ...
    repopulateFromCache: function () {
      ...
      // Get from cache!
      var cachedDropdowns = localStorage.getItem("cachedDropdowns");
      if (!cachedDropdowns) return false;

      // Array conversion
      var cachedDropdownsArr = JSON.parse(cachedDropdowns);
      for (var key in cachedDropdownsArr) {
        jQuery(
          '[data-dropdown-ajax-source="' + cachedDropdownsArr[key]["url"] + '"]'
        )
          .addClass("js-cached")
          .next()
          .closest(".dropdown-menu")
          .html(cachedDropdownsArr[key]["html"]);
      }
    ...
    validateCache: function (_URL) {
      // Get from cache!
      var cachedDropdowns = localStorage.getItem("cachedDropdowns");
      if (!cachedDropdowns) return true; // true = continue
    ...
    ddImageSwitcher: function () {
      ...
      $.SOW.vanilla.each(".dropdown-image-list", function (el) {
        ...
        if (el.classList.contains("js-ddimg")) return null;
        ...
        $.SOW.vanilla.on(el, "click", function (e) {
          ...
          if (_t.classList.contains("js-ddimg")) return;

          _t.classList.add("js-ddimg");
          // --

          var _imageContainer =
              _t.querySelector(".dropdown-image-container") || "",
            /* dropdown container */
            ddContainer = _t.nextElementSibling || "",
            ddAjaxContainer =
              ddContainer.querySelector(".dropdown-ajax-container") || "",
            /* ajax : populate : get images */
            _ajaxPopulateUrl =
              ddContainer.getAttribute("data-ddimg-ajax-populate-url") || "",
            _ajaxPopulateParams =
              ddContainer.getAttribute("data-ddimg-ajax-populate-params") || "",
            _ajaxPopulateMethod =
              ddContainer.getAttribute("data-ddimg-ajax-populate-method") ||
              "GET",
            _ajaxPopulateClass =
              ddContainer.getAttribute("data-ddimg-ajax-populate-class") ||
              "float-start w--80 h--80 m-1 p-0 rounded overflow-hidden overlay-dark-hover overlay-opacity-3",
            /* ajax : update : selected image */
            _ajaxUpdateUrl =
              ddContainer.getAttribute("data-ddimg-ajax-update-url") || "",
            _ajaxUpdateParams =
              ddContainer.getAttribute("data-ddimg-ajax-update-params") || "",
            _ajaxUpdateMethod =
              ddContainer.getAttribute("data-ddimg-ajax-update-method") ||
              _ajaxPopulateMethod,
            /* toast message */
            toastMsg =
              ddContainer.getAttribute("data-ddimg-toast-success") ||
              "Successfully Updated!",
            toastPosition =
              ddContainer.getAttribute("data-ddimg-toast-position") ||
              "top-center",
            useCache = ddContainer.getAttribute("data-ddimg-cache") || "true",
            noImgText =
              ddContainer.getAttribute("data-ddimg-noimg-text") || "No Images!",
            /* loading classes */
            clsContainer =
              "fa fa-orbit fi-spin fs--30 text-muted h--80 d-middle",
            clsItem =
              "fs--25 transition-none fa fa-orbit fi-spin overlay-light overlay-opacity-4 text-white";
          ...
          if (_ajaxPopulateParams != "") {
            var ajax_params_arr = $.SOW.helper.params_parse(
              _ajaxPopulateParams
            );
            for (var i = 0; i < ajax_params_arr.length; ++i) {
            ...
            $.SOW.vanilla.ajax({
              ...
              success: function (data) {
                ...
                if (data.length < 1) {
                  ...
                  ddAjaxContainer.innerHTML =
                    '<span class="p-2 text-muted">' + noImgText + "</span>";
                  return;
                }
          ...
          function _updateBind() {
            ...
            var objUpdate = ddContainer.querySelectorAll(
              ".dropdown-image-item"
            );
          ...
          function __itemUpdate(img_src, img_id) {
            ...
            if (_t.querySelector(".dropdown-ddimg-img-id"))
              _t.querySelector(".dropdown-ddimg-img-id").setAttribute(
                "value",
                img_id
              );

            if (_t.querySelector(".dropdown-ddimg-img-src"))
              _t.querySelector(".dropdown-ddimg-img-src").setAttribute(
                "value",
                img_src
              );
  ...
  $.SOW.core.count_animate = {
    ...
    process: function (_this) {
      ...
      _this.not(".js-count-completed").each(function (e) {
        ...
        /* on scroll down only */
        if (scrollPos > elOffsetTop) $.SOW.core.count_animate.animate(_t);
      });
    },
    ...
    animate: function (_t) {
      var count_from = _t.attr("data-count-from") || 0,
        ...
        count_duration =
          _t.attr("data-count-duration") ||
          $.SOW.core.count_animate.count_duration,
        callback = _t.data("count-callback") || "",
        count_decimals = _t.data("count-decimals") || "",
        oncomplete = _t.data("count-oncomplete") || "";

      if (count_from == count_to) return;

      // https://api.jquery.com/animate/
      jQuery({ sowCount: count_from }).animate(
        { sowCount: count_to },
        {
    ...
    btn_process: function (el_selector, btn_selector) {
      if (jQuery(btn_selector).length < 1) return;
      ...
      jQuery(btn_selector).each(function () {
        var _thisBtn = jQuery(this),
          _action =
            _thisBtn.is("a") || _thisBtn.is("button") ? "click" : "change";
    ...
    btn_process_math: function (_t) {
      ...
      if (is_select) {
        ...
        (_lastCalc = _tMth.attr("data-count-to") || 0), (_calculate = _val);
        ...
        if (el_type == "radio")
          var _calculate =
            _t.hasClass("active") || _t.is(":checked")
              ? Number(_baseVal) + _math
              : Number(_lastCalc) - _math;
        // invert the math because 'active' class is toggled before
        else
          var _calculate =
            _t.hasClass("active") || _t.is(":checked")
              ? Number(_lastCalc) + _math
      ...
      jQuery(_target).each(function (e) {
        ...
        if (typeof _json === "object") {
          ...
          if (window.sowCountBtnList[_elID] === 1) {
            ...
            _el.attr(
              "data-count-from",
              _json[1]["from"] != "0" ? _json[1]["to"] : _json[0]["from"]
            );
      ...
      _this
        ...
        .on("click", function (e) {
          ...
          var _t = jQuery(this),
            ...
            _requestMethod =
              _t.data("toggle-ajax-method") ||
              $.SOW.core.btn_toggle.config.method, // send request to the server when off
          ...
          if (_target == "" && _targetRw != "") _target = _targetRw;
          ...
          /**
				...
				**/
          if (_requestOff == "" && _requestOn == "") return null;
          ...
          jQuery.ajax({
            ...
            beforeSend: function () {
              $.SOW.helper.consoleLog(
                "SOW Btn Toggle [Ajax][Request Sent]: " + _url
              );
            },
            ...
            success: function (data) {
              $.SOW.helper.consoleLog(
                "SOW Btn Toggle [Ajax][Server Response]: " + data
              );
...
(function ($) {
  ...
  $.SOW.core.nav_deep = {
      ...
      _this
        ...
        .each(function () {
          ...
          $(".nav-link", jQuery(this)).on("click", function (e) {
            ...
            if (!js_ignore) $.SOW.core.nav_deep.nav_deep_close_all(_t);

            // --
            if (_href == "#" || _href == "#!") e.preventDefault();
          });
        });
    },
    ...
    nav_deep_close_all: function (_t) {
      ...
      _t.parent(".nav-item")
        ...
        .slideUp(this.config.speed, function (e) {
          jQuery(this)
            ...
            .next()
            .find("ul.nav")
            .css({ display: "" }); // remove display: block added by slideUp()
        });
      ...
      setTimeout(function () {
        // do not interfere with the one above!
        _t.parent(".nav-item")
          .parent()
          .find(".nav-item.active")
          .not(_t.parent(".nav-item"))
    ...
    asideScrollToActiveLink: function (selector) {
      if (jQuery("aside " + selector + " .nav-item.active").length < 1) return;

      var activeLinkOffset = jQuery(
        "aside " + selector + " .nav-item.active"
      ).offset();
      ...
      var scrollDivTo =
        activeLinkOffset.top -
        scrollableDivOffset.top -
        Math.round($.SOW.globals.height / 8);

      if (activeLinkOffset.top < $.SOW.globals.height) return;
...
(function ($) {
  ...
  $.SOW.core.form_validate = {
    ...
    form_validate: function (_this) {
      ...
      if (
        jQuery(_selector).hasClass(".js-ajax") &&
        typeof $.SOW.core.ajax_form === "object"
      ) {
        $.SOW.helper.consoleLog(
          "Ajax Form Detected! " + scriptInfo + " Skipped!"
        );
        return;
      }
      ...
      _this.submit(function (e) {
        ...
        if (!_form.checkValidity()) {
          ...
          if (_toast_text != "") {
            ...
            // error info delay timeout
            var _delay =
              jQuery(".bs-validate-info", _t).data("error-alert-delay") || 3000;
  ...
  $.SOW.core.form_advanced = {
    ...
    config: {
      ...
      /*
			...
			*/
      selector_advanced_char_count_down:
        "input.js-form-advanced-char-count-down, textarea.js-form-advanced-char-count-down",
      selector_advanced_char_count_up:
        "input.js-form-advanced-char-count-up, textarea.js-form-advanced-char-count-up",
    ...
    init: function (selector, config) {
      ...
      // 1. Bulk
      $.SOW.core.form_advanced.form_advanced_bulk(
        this.config.selector_advanced_bulk
      );

      // 2. Form input numeric limit
      $.SOW.core.form_advanced.form_advanced_numeric_limit(
        this.config.selector_advanced_numeric_limit
      );

      // 3. Form char count down
      $.SOW.core.form_advanced.form_advanced_char_count_down(
        this.config.selector_advanced_char_count_down
      );

      // 4. Form char count up
      $.SOW.core.form_advanced.form_advanced_char_count_up(
        this.config.selector_advanced_char_count_up
      );

      // 5. Form password toggle
      $.SOW.core.form_advanced.form_advanced_type_toggle(
        this.config.selector_advanced_type_toggle
      );
    ...
    form_advanced_bulk: function (_this) {
      ...
      jQuery(_this)
        ...
        .on("click", function (e) {
          ...
          var _t = jQuery(this),
            _citems =
              _t.data("js-form-advanced-bulk-container-items") || "table tbody", // from what container to count checked items?
            _reqSelectedItems =
              _t.data("js-form-advanced-bulk-required-selected") ||
              $.SOW.core.form_advanced.config.advanced_bulk_selected_require,
            _requiredMsg =
              _t.data("js-form-advanced-bulk-required-txt-error") ||
              $.SOW.core.form_advanced.config.toast_msg_noitems,
            _requiredMsgPos =
              _t.data("js-form-advanced-bulk-required-txt-position") ||
              $.SOW.core.form_advanced.config.toast_pos, // button icon
            // Modal
            _reqModalCustom =
              _t.data("js-form-advanced-bulk-required-custom-modal") || "", // modal id
            _reqModalCustomAjaxUrl =
              _t.data(
                "js-form-advanced-bulk-required-custom-modal-content-ajax"
              ) || "",
            _reqModalType =
              _t.data("js-form-advanced-bulk-required-modal-type") ||
              "secondary", // 'custom' : In case we want an ajax modal, fully customizable (no header/body/footer)
            _reqModalSize =
              _t.data("js-form-advanced-bulk-required-modal-size") ||
              "modal-md",
            _reqModalBackdrop =
              _t.data("js-form-advanced-bulk-required-modal-backdrop") || "", // static
            _reqModalTitle =
              _t.data("js-form-advanced-bulk-required-modal-txt-title") ||
              "Please Confirm",
            _reqModalTxtSubtitle =
              _t.data("js-form-advanced-bulk-required-modal-txt-subtitle") ||
              "-",
            _reqModalTxtBodyTxt =
              _t.data("js-form-advanced-bulk-required-modal-txt-body-txt") ||
              "Are you sure?",
            _reqModalTxtBodyInfo =
              _t.data("js-form-advanced-bulk-required-modal-txt-body-info") ||
              "",
            _reqModalBtnTxtYes =
              _t.data("js-form-advanced-bulk-required-modal-btn-text-yes") ||
              "Submit",
            _reqModalBtnTxtNo =
              _t.data("js-form-advanced-bulk-required-modal-btn-text-no") ||
              "Cancel",
            _reqModalBtnIcoYes =
              _t.data("js-form-advanced-bulk-required-modal-btn-icon-yes") ||
              $.SOW.config.sow__icon_check, // button icon
            _reqModalBtnIcoNo =
              _t.data("js-form-advanced-bulk-required-modal-btn-icon-no") ||
              $.SOW.config.sow__icon_close, // button icon
            // Form
            _formID = _t.attr("data-js-form-advanced-form-id") || "", // form#id .attr REQUIRED, or old one used!
            _formSubmitNoConfirm =
              _t.data("js-form-advanced-bulk-submit-without-confirmation") ||
              "false",
            // Hidden action input
            _formActionID =
              _t.data("js-form-advanced-bulk-hidden-action-id") || "#action",
            _formActionVal =
              _t.data("js-form-advanced-bulk-hidden-action-value") || "";
          ...
          if (_reqSelectedItems == true && Number(total_selected_items) < 1) {
            ...
            if (typeof $.SOW.core.toast === "object") {
              ...
              $.SOW.core.toast.show(
                ...
                _requiredMsg,
                _requiredMsgPos,
                $.SOW.core.form_advanced.config.toast_delay,
                true
              );
            } else {
              alert(_requiredMsg);
          ...
          if (_formActionVal != "") jQuery(_formActionID).val(_formActionVal);
          ...
          if (_reqModalBtnIcoNo.length > 1)
            var _reqModalBtnTxtNo =
              '<i class="' + _reqModalBtnIcoNo + '"></i> ' + _reqModalBtnTxtNo;

          // Replacements
          _reqModalTitle = _reqModalTitle.replace(
            "{{noSelected}}",
            total_selected_items
          );
          _reqModalTxtBodyTxt = _reqModalTxtBodyTxt.replace(
            "{{noSelected}}",
            total_selected_items
          );
          _reqModalTxtBodyInfo = _reqModalTxtBodyInfo.replace(
            "{{noSelected}}",
            total_selected_items
          );
          _reqModalTxtSubtitle = _reqModalTxtSubtitle.replace(
            "{{noSelected}}",
            total_selected_items
          );

          // Additional info
          var _reqModalTxtBodyTxt =
            _reqModalTxtBodyInfo != ""
              ? _reqModalTxtBodyTxt +
                '<span class="d-block d-block fs--12 mt--3">' +
                _reqModalTxtBodyInfo +
                "</span>"
              : _reqModalTxtBodyTxt;
          ...
          if (_reqModalCustom != "") {
            ...
            if (_reqModalCustom != "")
              $.SOW.core.form_advanced.form_advanced_bulk_counter_update(
                total_selected_items
              );
            ...
            if (_reqModalCustomAjaxUrl != "") {
              jQuery(_reqModalCustom)
                .find(".modal-content")
                .load(_reqModalCustomAjaxUrl, function () {
                  // Update selected items counter
                  $.SOW.core.form_advanced.form_advanced_bulk_counter_update(
                    total_selected_items
                  );
          ...
          var _tpl =
            ...
            "</div>" +
            '<div class="modal-footer">' +
            '<button type="submit" class="btn pt--10 pb--10 fs--16 btn-js-advanced-form-bulk-confirm-yes btn-' +
            _reqModalType +
            '">' +
            _reqModalBtnTxtYes +
            "</button>" +
          ...
          if (_reqModalType == "custom") {
            var _tpl = _tplCustom,
              _modalBody =
                "#js_advanced_form_bulk_modal_confirm .modal-content";
          }
          ...
          // Show Modal
          jQuery("#js_advanced_form_bulk_modal_confirm")
            .modal("handleUpdate")
            .modal("show");
          ...
          if (jQuery(".modal-backdrop").length < 1) {
            ...
            jQuery("#js_advanced_form_bulk_modal_confirm").on(
              "hidden.bs.modal",
              function (e) {
                jQuery(".modal-backdrop").remove();
              }
          ...
          if (_reqModalCustomAjaxUrl != "") {
            jQuery(_modalBody)
              .empty()
              .append(
                '<div class="py-4 text-center animate-bouncein"><i class="' +
                  $.SOW.config.sow__icon_loading +
                  ' fs--40 text-muted"></i></div>'
              );
    ...
    form_advanced_numeric_limit: function (_this) {
      if (jQuery(_this).length < 1) return;
      ...
      jQuery(_this).keyup(function () {
        ...
        if (Number(_val) < Number(_min)) _t.val(_min);
    ...
    formAdvancedList: function () {
      jQuery(".form-advanced-list").each(function () {
        var _t = jQuery(this),
          ...
          _disableRequired =
            _t.attr("data-form-advanced-list-hidden-required") || "false",
          _disableHidden =
            _t.attr("data-form-advanced-list-hidden-disable") || "false",
          _disableHiddenByClass =
            _t.attr("data-form-advanced-list-hidden-disable-class") || "";
        ...
        if (_disableRequired == "true" && _listReavealCount > 0) {
          if (_disableHidden == "true") {
            jQuery(".form-advanced-list-reveal-item [disabled]", _t)
              .not(".js-form-advanced-list-ignore")
              .addClass("js-form-advanced-disabled");
            jQuery(".form-advanced-list-reveal-item:hidden [disabled]", _t)
              .addClass("js-form-advanced-disabled")
              .not(".js-form-advanced-list-ignore")
              .prop("disabled", false);
          }
          ...
          if (_disableHiddenByClass != "") {
            jQuery(
              ".form-advanced-list-reveal-item " + _disableHiddenByClass,
              _t
            )
              .not(".js-form-advanced-list-ignore")
              .addClass("js-form-advanced-disabled-class");
            jQuery(
              ".form-advanced-list-reveal-item:hidden " + _disableHiddenByClass,
              _t
            )
              .addClass("js-form-advanced-disabled-class")
              .not(".js-form-advanced-list-ignore")
          ...
          jQuery(".form-advanced-list-reveal-item [required]", _t).addClass(
            "js-form-advanced-required"
          );
          jQuery(".form-advanced-list-reveal-item:hidden [required]", _t)
            .addClass("js-form-advanced-required")
            .prop("required", false);
        }
        // ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        ...
        jQuery(".form-advanced-list-reveal", _t).on("change", function () {
          ...
          // hide all first
          jQuery(".form-advanced-list-reveal-item", _t).addClass(
            "hide hide-force"
          );
              ...
              jQuery(__target)
                .load(__ajax, function () {
                  ...
                  setTimeout(function () {
                    ...
                    // ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
                    jQuery(
                      ".form-advanced-list-reveal-item [required]",
                      _t
                    ).addClass("js-form-advanced-required");
                    jQuery(
                      ".form-advanced-list-reveal-item:hidden [required]",
                      _t
                    )
                      .addClass("js-form-advanced-required")
                      .prop("required", false);
                    ...
                    if (_disableHiddenByClass != "") {
                      jQuery(
                        ".form-advanced-list-reveal-item:visible " +
                          _disableHiddenByClass,
                        _t
                      )
                        .not(".js-form-advanced-list-ignore")
                        .prop("disabled", false);
                      jQuery(
                        ".js-form-advanced-disabled-class:hidden" +
                          _disableHiddenByClass,
                        __target
                      )
                        .not(".js-form-advanced-list-ignore")
                    ...
                    jQuery(".js-form-advanced-required:visible", __target).prop(
                      "required",
                      true
                    );
                    // ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
          ...
          if (__target != "" && _disableRequired == "true") {
            ...
            if (_disableHidden + "" == "true") {
              jQuery(".form-advanced-list-reveal-item:hidden [disabled]", _t)
                .not(".js-form-advanced-list-ignore")
                .prop("disabled", false);
              jQuery(".js-form-advanced-disabled:visible", __target)
                .not(".js-form-advanced-list-ignore")
                .prop("disabled", true);
            }
      ...
      jQuery("a.form-advanced-reset, button.form-advanced-reset")
        ...
        .each(function (e) {
          ...
          _t.on("click", function (e) {
            ...
            jQuery(_target + " input")
              .not(_exclude)
              .val("");
            jQuery(_target + " textarea")
              .not(_exclude)
              .val("");
            jQuery(_target + " input[type=checkbox]")
              .not(_exclude)
              .prop("checked", false);
            jQuery(_target + " input[type=radio]")
              .not(_exclude)
              .prop("checked", false);

            // hide reset button
            if (!_t.hasClass("js-ignore")) _t.addClass("hide hide-force");
          });
        });
    },
        ...
        .each(function (e) {
          ...
          jQuery(
            'input[data-target="#' +
              ...
              '"], a[href="#' +
              _elID +
              '"], .js-form-advanced-required-toggler'
          ).on("click", function (e) {
            $.SOW.core.form_advanced.__switchFormAdvancedRequired();
          });
          jQuery("select.js-form-advanced-required-toggler").on(
            "change",
            function (e) {
              $.SOW.core.form_advanced.__switchFormAdvancedRequired();
            }
      ...
      jQuery("div.js-form-advanced-table")
        ...
        .each(function (e) {
          var _t = jQuery(this),
            _elID = _t.attr("id") || "",
            _columnBefore =
              _t.data("table-column-insert-before") || "tr>td:first-child",
            _columnElement =
              _t.data("table-column-insert-element") ||
              '<input type="text" class="form-control form-control-sm" value="">',
            _columnDelBtn =
              _t.data("table-column-delete-button") ||
              '<span class="btn-table-column-delete fa fa-close fs--16 cursor-pointer px-1 d-inline-block"></span>',
          ...
          // resets
          jQuery("input, textarea", _clone)
            .val("")
            .removeClass(
              "js-tangepickified js-rangepickified js-bselectified js-datepickified js-advancified"
            );
          jQuery("a.btn-table-clone", _clone)
            .removeClass("btn-table-clone btn-primary btn-danger btn-secondary")
            .addClass("btn-table-clone-remove btn-light")
            .attr("aria-expanded", "true");
          // reset : file upload, if has items
          if (jQuery("input.custom-file-input", _clone).length > 0) {
            var _fileUploadPrevContainer = jQuery(
                "input.custom-file-input",
                _clone
              ).attr("data-file-preview-container"),
              _fileUploadRemoveButton = jQuery(
                "input.custom-file-input",
                _clone
              ).attr("data-file-btn-clear");
          ...
          jQuery("a.btn-table-clone", _t).on("click", function (e) {
            ...
            if (jQuery("input.custom-file-input", _clone).length > 0) {
              ...
              var _fileUploadRemoveButton = jQuery(
                  "input.custom-file-input",
                  _clone
                ).attr("data-file-btn-clear"),
              ...
              jQuery("input.custom-file-input", _clone).attr(
                "data-file-preview-container",
                "." + _fileUploadPrevContainer + "_" + _cloneID
              );
              jQuery("input.custom-file-input", _clone).attr(
                "data-file-btn-clear",
                "." + _fileUploadRemoveButton + "_" + _cloneID
              );
              jQuery("." + _fileUploadPrevContainer, _clone)
                .removeClass(_fileUploadPrevContainer)
                .addClass(_fileUploadPrevContainer + "_" + _cloneID);
              jQuery("." + _fileUploadRemoveButton, _clone)
                .removeClass(_fileUploadRemoveButton)
                .addClass(_fileUploadRemoveButton + "_" + _cloneID);
            }
          ...
          /* COLUMN ADD */
          jQuery(".js-form-advanced-table-column-add button", _t).on(
            "click",
            function (e) {
              e.preventDefault();
              ...
              var _optionName =
                  _optionName == ""
                    ? _columnName
                    : _optionName + "[" + _columnName + "]",
                _optionName = _optionName.toLowerCase();
              var _colID = "js_" + $.SOW.helper.randomStr(6);
              var _columnNameUcFirst = _columnName.replace(
                /^./,
                _columnName[0].toUpperCase()
              );

              // check if already exist
              if (
                jQuery('tbody [name="' + _optionName + '[]"]', _t).length > 0
              ) {
              ...
              jQuery(
                "thead th[data-id=" + _colID + "] .btn-table-column-delete",
                _t
              ).on("click", function (e) {
                e.preventDefault();
                ...
                if (Number(_columnLimit) > 0) {
                  if (
                    jQuery("thead th.js-table-option", _t).length <
                    Number(_columnLimit)
                  ) {
                    jQuery(".js-form-advanced-table-column-add button", _t)
                      .removeClass("disabled")
                      .prop("disabled", false);
                    jQuery(".js-form-advanced-table-column-add input", _t).prop(
                      "disabled",
                      false
                    );
                  }
          ...
          /* ON LOAD : ROW REMOVE */
          function __rowDel() {
            jQuery("table>tbody>tr>td a.btn-table-clone-remove", _t)
              .off()
              .on("click", function (e) {
                e.preventDefault();
                ...
                if (Number(_cloneLimit) > 0) {
                  if (
                    jQuery("table>tbody>tr", _t).length < Number(_cloneLimit)
                  ) {
                    jQuery(".btn-table-clone", _t)
                      .removeClass("disabled")
                      .prop("disabled", false);
            ...
            // confirm
            jQuery("table>tbody>tr>td .btn-table-clone-remove-confirm", _t)
              .off()
              .on("click", function (e) {
                e.preventDefault();
            ...
            // confirm cancel
            jQuery("table>tbody>tr>td .btn-table-clone-remove-cancel", _t)
              .off()
              .on("click", function (e) {
                e.preventDefault();
        ...
        .each(function () {
          ...
          jQuery("input:checkbox", _target).on("click", function () {
            ...
            if (!jQuery(this).is(":checked")) {
              jQuery(
                'input.checkall[data-checkall-container="' + _target + '"]'
              ).prop("checked", false);
            }
          });
  ...
  $.SOW.core.checkgroup = {
      ...
      _this
        ...
        .each(function () {
          var _t = jQuery(this),
            ...
            toastMsg =
              _t.attr("data-checkgroup-ajax-toast-success") || "Changes Saved",
            toastPosition =
              _t.attr("data-checkgroup-ajax-toast-position") || "top-center";
          ...
          jQuery("input[type=checkbox], input[type=radio]", _t).each(
            function () {
              jQuery(this).on("click", function () {
                // Switch radios
                if (isUnique + "" == "true")
                  jQuery("input[type=checkbox]", _t)
                    .not(this)
                    .prop("checked", false);
                ...
                if (ajaxURL != "") {
                  ...
                  jQuery("input[type=checkbox], input[type=radio]", _t).each(
                    function () {
                      ...
                      if (itemParams != "") {
                        ...
                        for (var i = 0; i < ajax_params_arr.length; ++i) {
                          itemParamsObj[ajax_params_arr[i][0]] =
                            ajax_params_arr[i][1];
                        }
                      }
                      // --
                  ...
                  // Ajax Request
                  $.SOW.core.checkgroup.ajaxRequest(
                    ajaxURL,
                    ajaxMethod,
                    ajaxParamObj,
                    toastMsg,
    ...
    ajaxRequest: function (
      ...
      jQuery.ajax({
        ...
        success: function (data) {
          // Debug
          if ($.SOW.config.sow__debug_enable === true) console.log(data);
...
(function ($) {
  ...
  $.SOW.core.gdpr = {
    ...
    process: function (_selector) {
      var __gdpr = Cookies.get($.SOW.core.gdpr.config.cookie_name, {
        path: $.SOW.core.gdpr.config.cookie_path,
      });
      ...
      if (window.location.hash == "#del:gdpr") {
        $.SOW.helper.consoleLog(
          $.SOW.core.gdpr.config.cookie_name + ": Hash Request"
        );
        $.SOW.core.gdpr.destroy();
        var __gdpr = null;
      }
      ...
      if (__gdpr == null) {
        ...
        $.SOW.helper.consoleLog(
          $.SOW.core.gdpr.config.cookie_name + ": Refresh"
        );
        Cookies.set($.SOW.core.gdpr.config.cookie_name, __gdpr, {
          expires: $.SOW.core.gdpr.config.cookie_expire,
          path: $.SOW.core.gdpr.config.cookie_path,
        }); // refresh
        ...
        .on("click", function (e) {
          ...
          /*
					values:
						...
						2 = website + advertising
				*/
          Cookies.set($.SOW.core.gdpr.config.cookie_name, 0, {
            expires: $.SOW.core.gdpr.config.cookie_expire,
            path: $.SOW.core.gdpr.config.cookie_path,
          });
          jQuery(_selector).remove(); // just in case
          $.SOW.helper.consoleLog(
            $.SOW.core.gdpr.config.cookie_name +
              ": Accepted. Delete cookie by hash: #del:gdpr (developing purpose)"
          );
        });
    ...
    extend: function (__gdprLevel) {
      $.SOW.core.gdpr.destroy();
      $.SOW.helper.consoleLog(
        $.SOW.core.gdpr.config.cookie_name + ": Level: " + __gdprLevel
      );
      Cookies.set($.SOW.core.gdpr.config.cookie_name, __gdprLevel, {
        expires: $.SOW.core.gdpr.config.cookie_expire,
        path: $.SOW.core.gdpr.config.cookie_path,
      });
      return true;
    ...
    destroy: function () {
      ...
      Cookies.remove($.SOW.core.gdpr.config.cookie_name, { path: "/" });
      Cookies.remove($.SOW.core.gdpr.config.cookie_name, {
        path: $.SOW.core.gdpr.config.cookie_path,
      });
      $.SOW.helper.consoleLog(
        $.SOW.core.gdpr.config.cookie_name + " : Cookie Deleted"
      );
      return true;
    },
  };
...
(function ($) {
  ...
  $.SOW.core.sidebar = {
     ...
     **/
    init: function (selector, config) {
      if (jQuery("aside").length < 1) return;
...
(function ($) {
  ...
  $.SOW.core.scroll_to = {
    ...
    process: function (_this) {
      ...
      _this
        ...
        .on("click", function (e) {
          ...
          if (_toggle == "collapse") _delay = _delay > 0 ? _delay : 300; // bootstrap default is 400
          ...
          if (typeof $.SOW.helper.scrollAnimate === "function") {
            setTimeout(function () {
              ...
              if (_t.hasClass("collapsed")) return;
    ...
    scrollToTop: function () {
      ...
      var minInitHeight =
        $.SOW.globals.is_mobile === true
          ? $.SOW.core.scroll_to.config.s2t_mob_minH
          : $.SOW.core.scroll_to.config.s2t_dsk_minH;

      // do not init on short content
      if ($(document).height() < minInitHeight) return;

      var _pos =
        $.SOW.globals.elBody.data("s2t-position") ||
        $.SOW.core.scroll_to.config.s2t_position;
      var _cls =
        $.SOW.globals.elBody.data("s2t-class") ||
        $.SOW.core.scroll_to.config.s2t_class;
      ...
      if (
        ...
        if (footerHeight < 200) {
          ...
          var btnScrollToMargins =
            footerHeight +
            15 +
            Number($.SOW.globals.elBody.css("padding").replace("px", "") || 0) +
            Number($.SOW.globals.elBody.css("margin").replace("px", "") || 0);
        }
      }

      // Create Element
      $.SOW.globals.elBody.append(
        '<a aria-label="Scroll page to top" href="#" id="btnScrollTo" class="btn ' +
          _cls +
          " position-fixed z-index-99 " +
          _pos +
          '-0 bottom-0 m-2" style="display:none"><i class="m-0 fa fa-arrow-up"></i></a>'
      );
            ...
            if (currScrollPos + $.SOW.globals.height > footerPos) {
              if (tookCare === false) {
                jQuery("#btnScrollTo")
                  ...
                  .attr(
                    "style",
                    "margin-bottom: " + btnScrollToMargins + "px !important"
                  );
                tookCare = true;
              }
            } else {
...
(function ($) {
  ...
  $.SOW.core.search_inline = {
    ...
    process: function (_this) {
      // --
      if (_this.hasClass("iqs-init")) return;
      ...
      _this.keyup(function () {
        ...
        if (keywords == "") {
          ...
          jQuery(_container + " .iqs-item :containsIN(" + keywords + ")")
            .closest(".iqs-item")
            .removeClass("hide hide-force");
        }
      });
...
(function ($) {
  ...
  $.SOW.core.input_suggest = {
    ...
    process: function (_this) {
      // --
      if (_this.hasClass("is-init")) return;
      ...
      var _elID = _this.attr("id") || "",
        ...
        _stripTags =
          _this.attr("data-input-suggest-append-stip-tags") || "true";
      ...
      if (_type == "append" || _type == "self") {
        _this.on("keyup change", function (e) {
          ...
          window.afterSearchKeyUp = setTimeout(function () {
            ...
            if (_action == "") _action = "input_search";

            if (_key.length >= Number(_charMin)) {
              jQuery("#dd_" + _elID + ">div")
                .empty()
                .append(
                  '<div class="text-center"><i class="fa fa-circle-spin fi-spin text-muted fs--30"></i></div>'
                );
              $.SOW.core.input_suggest.__suggestAjax(
                _url,
                _method,
                _limit,
                _action,
        ...
        _this.on("click", function (e) {
          var _this = jQuery(this);
          if (_action == "") _action = "input_suggest";
          ...
          if (_this.val() == "")
            jQuery("#dd_" + _elID + " .iqs-item").removeClass(
              "hide hide-force"
            );
        });
      }
    ...
    __suggestAjax: function (
      ...
      jQuery.ajax({
        ...
        success: function (data) {
              ...
              if (_data[i].disabled == true)
                ...
                jQuery("#dd_" + _elID + ">div").append(
                  '<a href="' +
                    ...
                    '" data-id="' +
                    _data[i].id +
                    '" class="dropdown-item px-2"><span>' +
                    _data[i].label +
                    "</span></a>"
                );
            } else
              jQuery("#dd_" + _elID + ">div").append(
                '<a href="#!" class="iqs-item dropdown-item px-2"><span>' +
                  _data[i] +
                  "</span></a>"
              );
          }
          ...
          // Activate click
          jQuery("#dd_" + _elID + " a.dropdown-item")
            .off()
            .on("click", function (e) {
              e.preventDefault();
    ...
    __suggestJsonParse: function (data) {
      ...
      if (typeof _data === "undefined" || _data.length < 1) return null;

      // check
      if (
        typeof _data[0].label === "undefined" &&
        typeof _data[0].length === "undefined"
      )
        return null;
    ...
    __suggestTPL: function (_this, _elID) {
      ...
      if (jQuery("#dd_" + _elID).length < 1) {
        ...
        __el.after(
          '<div id="dd_' +
            _elID +
            '" class="dropdown-menu p-1 w-100"><div class="max-h-200 scrollable-vertical"></div></div>'
        );
      }
    ...
    __suggestAppend: function (
      ...
      var _tpl =
        ...
        '<a href="#!" class="item-suggest-append-remove fa fa-close fs--16 float-start text-decoration-none"></a>';
      ...
      if (item_url != "" && item_url != "#" && item_url != "#!")
        _tpl +=
          ...
          item_label +
          "</a>";
      else _tpl += "<span>" + item_label + "</span>";
    ...
    __suggestAppendedRemove: function (_container) {
      ...
      // Remove button
      jQuery(_container + " a.item-suggest-append-remove")
        .off()
        .on("click", function (e) {
          e.preventDefault();
  ...
  $.SOW.core.timer_countdown = {
    ...
    process: function (_this) {
      ...
      if (typeof _time === "number") {
        ...
        window.timeleft[_elID] =
          _time > 1000 ? Math.round(_time / 1000) : Math.round(_time);
      } else {
      ...
      /*
			...
			*/
      if (window.timeleft[_elID] < 1) return;
    ...
    timer_compute: function (_this, _elID, _inline, _calledByInterval) {
      ...
      if (window.timeleft[_elID] < 0) {
        ...
        // Self hide
        if (_endSelfHide == true) _this.addClass("hide hide-force");
      ...
      var daysleft = $.SOW.helper.time_from_ms(
        window.timeleft[_elID] * 1000,
        "d"
      );
    ...
    timer_compute_stop: function (_elID) {
      // Stop loop!
      if (_elID) clearInterval(window._timerInterval[_elID]);
    ...
    timer2html: function (_this, timeString) {
      ...
      // calc no of years
      if (_days >= 365) _years = Math.floor(_days / 365); // round always down
...
(function ($) {
  ...
  $.SOW.core.gfont = {
     ...
     **/
    process: function (_this) {
      if (_this.hasClass("js-gfontified")) return;
...
(function ($) {
  ...
  $.SOW.core.utils = {
    ...
    init: function (selector, config) {
      ...
      $.SOW.core.utils.initialsFromString(
        this.selector +
          " " +
          $.SOW.core.utils.config.selector__initialFromString
      );

      // Time Ago
      $.SOW.core.utils.timeAgo(
        this.selector + " " + $.SOW.core.utils.config.selector__timeAgo
      );

      // Cookies
      $.SOW.core.utils.cookieUtil(
        this.selector + " " + $.SOW.core.utils.config.selector__cookie
      );

      // Background Slideshow
      $.SOW.core.utils.slideshow(
        this.selector + " " + $.SOW.core.utils.config.selector__slideshow
      );

      // Cloner
      $.SOW.core.utils.cloner(
        this.selector + " " + $.SOW.core.utils.config.selector__cloner
      );

      // Hide/Show/Readonly/Disable
      $.SOW.core.utils.UtilAction(
        this.selector + " " + $.SOW.core.utils.config.selector__action
      );

      // Form
      $.SOW.core.utils.UtilForm(
        this.selector + " " + $.SOW.core.utils.config.selector__form
      );

      // Form Live Monitor
      $.SOW.core.utils.UtilFormLiveMonitor(
        this.selector + " " + $.SOW.core.utils.config.selector__formLiveMonitor
      );

      // Live Reload
      $.SOW.core.utils.UtilLiveReload(
        this.selector + " " + $.SOW.core.utils.config.selector__liveReload
      );
    ...
    initialsFromString: function (selector) {
      ...
      if (loaded === true)
        $.SOW.helper.consoleLog(
          "Init : " + scriptInfo + " : Initials From String"
        );
      // -- * --
    },
    ...
    slideshow: function (selector) {
      ...
      el.each(function () {
        ...
        if (dataBgs.length < 10) return false;
        ...
        _t.prepend(
          '<div id="' +
            slideRand +
            '" class="sow-slideshow absolute-full z-index-0"></div>'
        );
        ...
        for (var i = 0; i < arrImgs.length; i++) {
          ...
          jQuery("#" + slideRand).prepend(
            '<span class="sow-slideshow-item sow-slideshow-item-' +
              i +
        ...
        if (arrImgs.length < 2) return false;
        ...
        function slideLooper() {
          slideshowList[slideRand].timeOutInstance = setTimeout(function () {
            ...
            if (next >= slideshowList[slideRand].itemsCount) next = 0;

            jQuery(
              "#" +
                slideRand +
                " span.sow-slideshow-item-" +
                slideshowList[slideRand].current
            ).fadeOut(dataFadeDelay);
            jQuery("#" + slideRand + " span.sow-slideshow-item-" + next).fadeIn(
              dataFadeDelay
            );
        ...
        function onVisibilityChanged() {
          if (
            ...
            slideshowList[slideRand].timeOutInstance = setTimeout(
              slideLooper,
              dataInterval
            );
          }
    ...
    cloner: function (selector) {
      ...
      el.not(".js-sowclonified")
        ...
        .on("click", function (e) {
          ...
          if (_target == "" || _destination == "") return null;
          ...
          // append clone
          if (_cloneMethod == "prepend") jQuery(_destination).prepend(clone);
          else jQuery(_destination).append(clone);

          // Clean inputs of clones
          jQuery(
            ".js-cloned-fresh input[type=text], .js-cloned-fresh input[type=email], .js-cloned-fresh input[type=number], .js-cloned-fresh textarea",
            _destination
          ).val(""); // empty
          ...
          /*
				...
				*/
          jQuery(
            ".js-cloned-fresh [data-cloned-replace-class]",
            _destination
          ).each(function () {
            var __t = jQuery(this);
            __t
              .removeAttr("class")
              .attr("class", __t.data("cloned-replace-class"))
          ...
          /*
				...
				*/
          jQuery(
            ".js-cloned-fresh [data-cloned-replace-name]",
            _destination
          ).each(function () {
            var __t = jQuery(this),
          ...
          /*
				...
				*/
          jQuery(
            ".js-cloned-fresh [data-cloned-replace-attribute-name]",
            _destination
          ).each(function () {
            var __t = jQuery(this),
            ...
            __t
              .removeAttr(_attrName)
              .attr(_attrName, _attrValue)
              .removeAttr(
                "data-cloned-replace-attribute-name, data-cloned-replace-attribute-value"
              );
          });
          ...
          jQuery(
            ".js-cloned-fresh " +
              selector +
              ", .js-cloned-fresh .btn-clone-remove"
          )
          ...
          jQuery(".js-cloned-fresh", _destination).removeClass(
            "js-cloned-fresh"
          );
      ...
      jQuery(".js-cloned")
        ...
        .each(function () {
          ...
          _href.on("click", function (e) {
            ...
            jQuery(this).parents(".js-cloned").remove();
            jQuery(".sow-util-cloner", _target)
              .removeClass("disabled")
              .prop("disabled", false);
            jQuery('a[data-clone-destination="' + _target + '"]')
              .removeClass("disabled")
              .prop("disabled", false);
          });
        });
    ...
    UtilAction: function (selector) {
      ...
      if (el.hasClass("js-sowutilified")) return;

      el.not(".js-sowutilified")
        ...
        .on("click", function (e) {
          var _t = jQuery(this),
            ...
            _targetClassToggleVal =
              _t.data("util-target-class-toggle-val") || "",
            ...
            _targetPlaceholderVal =
              _t.data("util-target-placeholder-val") || "",
            _targetReadonlyOn = _t.data("util-target-readonly-on") || "",
            _targetReadonlyOff = _t.data("util-target-readonly-off") || "",
            _targetReadonlyToggle =
              _t.data("util-target-readonly-toggle") || "",
            ...
            _targetAjaxMethod =
              _t.data("util-ajax-method") || $.SOW.core.utils.config.method,
            _targetAjaxParams = _t.data("util-ajax-params") || "",
            _targetAjaxAppend = _t.data("util-ajax-append-response") || "",
            _toastAjaxSuccessMsg =
              _t.data("util-ajax-toast-success") || "Sucessfully Updated!",
            _toastAjaxPosition =
              _t.data("util-ajax-toast-position") || "top-center",
          ...
          // remove element
          if (_targetRemove != "") jQuery(_targetRemove).remove();

          // group active
          // like checkboxes layout made of links
          if (_groupActive != "") {
            // current state
            var _tCurrState = _t.hasClass(_groupActiveClass)
              ? "active"
              : "inactive";
            ...
            if (_tCurrState == "active") _t.addClass(_groupActiveClass);
          }

          // readonly:on
          if (_targetReadonlyOn != "")
            jQuery(_targetReadonlyOn)
              .addClass("readonly")
              .attr("readonly", true)
              .prop("readonly", true);
          ...
          if (_targetAjaxRequest != "") {
            ...
            jQuery.ajax({
              ...
              beforeSend: function () {
                ...
                $.SOW.helper.consoleLog(
                  "SOW Util : [Ajax][Request Sent]: " + _targetAjaxRequest
                );
              },
              ...
              success: function (data) {
                $.SOW.helper.loadingSpinner("hide");
                $.SOW.helper.consoleLog(
                  "SOW Util : [Ajax][Server Response]: " + data
                );
    ...
    UtilForm: function (selector) {
      ...
      if (el.hasClass("js-sowformutilified")) return;

      el.not(".js-sowformutilified")
        ...
        .each(function (selector) {
          var _t = jQuery(this),
            ...
            _toastError =
              _t.attr("data-util-form-toast-error") ||
              "Unexpected Internal error!",
          ...
          _submitBtn.on("click", function (e) {
            ...
            if (_params != "") {
              ...
              for (var i = 0; i < ajax_params_arr.length; ++i) {
                _t.append(
                  '<input type="text" class="hide hide-force sow-util-tmp" name="' +
                    ajax_params_arr[i][0] +
                    '" value="' +
                    ajax_params_arr[i][1] +
                    '">'
            ...
            if (_method.toLowerCase() == "post") {
              ...
              var __processData = true;
              var __contentType =
                _contentType || $.SOW.core.utils.config.contentType;
    ...
    UtilFormLiveMonitor: function (selector) {
      ...
      if (el.hasClass("js-sowlfutilified")) return;

      el.not(".js-sowlfutilified")
        ...
        .each(function (e) {
          var _t = jQuery(this),
            ...
            _formLiveMonitorEl =
              _t.attr("data-util-live-monitor-elements") || "*",
            _formLiveMonitorAppendData =
              _t.attr("data-util-live-monitor-append-response") || "",
            _formLiveMonitorDelay =
              _t.attr("data-util-live-monitor-user-delay") || 1000,
            ...
            _toastPosition =
              _t.data("util-live-toast-position") || "top-center",
          ...
          jQuery(_formLiveMonitorEl, _t)
            ...
            .on("change", function (e) {
              ...
              if (_thisEl.hasClass("js-ignore")) return;
              ...
              _t.append(
                '<input class="js-append" type="hidden" name="ajax" value="true">'
              );
              if (_ajaxParams != "") {
                var ajax_params_arr = $.SOW.helper.params_parse(_ajaxParams);
                for (var i = 0; i < ajax_params_arr.length; ++i) {
                  _t.append(
                    '<input class="js-append" type="hidden" name="' +
                      ajax_params_arr[i][0] +
                      '" value="' +
                      ajax_params_arr[i][1] +
                      '">'
              ...
              window.afterLiveFormChange = setTimeout(function () {
                ...
                jQuery.ajax({
                  ...
                  beforeSend: function () {
                    ...
                    jQuery("button[type=submit]", formTag)
                      .addClass("disabled")
                      .prop("disabled", true);
                  },
    ...
    UtilLiveReload: function (selector) {
      $.SOW.vanilla.each(selector, function (_t) {
        /* Bind once! Ajax reinits */
        if (_t.classList.contains("js-sowrutilified")) return null;
        ...
        if (_htmlTag == "input") {
          ...
          if (_type == "radio" || _type == "checkbox") _action = "click";
        } else if (_htmlTag == "textarea") _action = "keyup";
        else if (_htmlTag == "select") _action = "change";
        else if (_htmlTag == "a" || _htmlTag == "button") _action = "click";
      ...
      function __utilLiveReloadFunction(_target) {
        ...
        var ajaxURL = _t.getAttribute("data-reload-ajax-url") || "",
          ...
          _showLoadingIcon =
            _t.getAttribute("data-ajax-show-loading-icon") || "true";
        ...
        if (window.afterFormChange) clearTimeout(window.afterFormChange);
        ...
        window.afterFormChange = setTimeout(function () {
          ...
          $.SOW.vanilla.ajax({
            ...
            success: function (data) {
              ...
              // form live monitor
              jQuery(".sow-util-form-live-monitor").removeClass(
                "js-sowlfutilified"
              );
              $.SOW.core.utils.UtilFormLiveMonitor(
                ".sow-util-form-live-monitor"
              );
...
if (typeof $.SOW.config.autoinit === "undefined") {
  $.SOW.config.autoinit = {};
}
$.SOW.config.autoinit["sow_header"] = [
  "$.SOW.core.header.init",
  "null",
  null,
  false,
];
$.SOW.config.autoinit["sow_search_suggest"] = [
  "$.SOW.core.search_suggest.init",
  "form.js-ajax-search",
  null,
  false,
];
$.SOW.config.autoinit["sow_lazyload"] = [
  "$.SOW.core.lazyload.init",
  ".lazy",
  null,
  true,
];
...
$.SOW.config.autoinit["sow_ajax_content"] = [
  "$.SOW.core.ajax_content.init",
  "div.js-ajax, section.js-ajax",
  null,
  true,
];
$.SOW.config.autoinit["sow_ajax_form"] = [
  "$.SOW.core.ajax_form.init",
  "form.js-ajax",
  null,
  true,
];
$.SOW.config.autoinit["sow_ajax_select"] = [
  "$.SOW.core.ajax_select.init",
  "select.js-ajax",
  null,
  true,
];
$.SOW.config.autoinit["sow_ajax_modal"] = [
  "$.SOW.core.ajax_modal.init",
  ".js-ajax-modal",
  { size: "modal-md" },
  true,
];
$.SOW.config.autoinit["sow_ajax_confirm"] = [
  "$.SOW.core.ajax_confirm.init",
  ".js-ajax-confirm",
  null,
  true,
];
$.SOW.config.autoinit["sow_file_upload"] = [
  "$.SOW.core.file_upload.init",
  'input[type="file"].custom-file-input',
  null,
  true,
];
$.SOW.config.autoinit["sow_toast"] = [
  "$.SOW.core.toast.init",
  "div.toast-on-load",
  null,
  true,
];
$.SOW.config.autoinit["sow_dropdown_click_ignore"] = [
  "$.SOW.core.dropdown_click_ignore.init",
  ".dropdown-menu.dropdown-click-ignore",
  null,
  true,
];
$.SOW.config.autoinit["sow_dropdown"] = [
  "$.SOW.core.dropdown.init",
...
$.SOW.config.autoinit["sow_count_animate"] = [
  "$.SOW.core.count_animate.init",
  "null",
  null,
  true,
];
$.SOW.config.autoinit["sow_btn_toggle"] = [
  "$.SOW.core.btn_toggle.init",
  ".btn-toggle",
  null,
  true,
];
$.SOW.config.autoinit["sow_nav_deep"] = [
  "$.SOW.core.nav_deep.init",
  ".nav-deep",
  { speed: 150 },
  true,
];
$.SOW.config.autoinit["sow_form_validate"] = [
  "$.SOW.core.form_validate.init",
  "form.bs-validate",
  null,
  true,
];
$.SOW.config.autoinit["sow_form_advanced"] = [
  "$.SOW.core.form_advanced.init",
  "null",
  null,
  true,
];
$.SOW.config.autoinit["sow_checkall"] = [
  "$.SOW.core.checkall.init",
  "input.checkall",
  null,
  true,
];
$.SOW.config.autoinit["sow_checkgroup"] = [
  "$.SOW.core.checkgroup.init",
  "div.checkgroup",
  null,
  true,
];
$.SOW.config.autoinit["sow_gdpr"] = [
  "$.SOW.core.gdpr.init",
  "#gdpr",
  { cookie_name: "__gdpr" },
  false,
];
$.SOW.config.autoinit["sow_sidebar"] = [
  "$.SOW.core.sidebar.init",
  "null",
  null,
  false,
];
$.SOW.config.autoinit["sow_scroll_to"] = [
  "$.SOW.core.scroll_to.init",
  "a.scroll-to",
  {
    speed: 400,
    s2t_enable: true,
...
$.SOW.config.autoinit["sow_search_inline"] = [
  "$.SOW.core.search_inline.init",
  "input.iqs-input",
  null,
  true,
];
$.SOW.config.autoinit["sow_input_suggest"] = [
  "$.SOW.core.input_suggest.init",
  "input.input-suggest",
  null,
  true,
];
$.SOW.config.autoinit["sow_timer_autohide"] = [
  "$.SOW.core.timer_autohide.init",
  ".timer-autohide",
  null,
  true,
];
$.SOW.config.autoinit["sow_timer_countdown"] = [
  "$.SOW.core.timer_countdown.init",
  ".timer-countdown",
  null,
  true,
];
$.SOW.config.autoinit["sow_gfont"] = [
  "$.SOW.core.gfont.init",
  "[data-gfont]",
  null,
  true,
