...
{
    public class CrudBaseController<T, TViewModel> : ControllerBase where T : class
    {
        protected IBaseAppService<T> _service;
        protected readonly IMapper _mapper;
        protected readonly ILogger<T> _logger;

        public CrudBaseController(IBaseAppService<T> service, IMapper mapper, ILogger<T> logger)
        {
            _service = service;
            _mapper = mapper;
            _logger = logger;
