...
namespace CrossCutting.Services.Services
{
    ...
    {
        readonly BingTranslateConfiguration _configuration;
        private readonly IMemoryCache _cache;

        public BingTranslateService(BingTranslateConfiguration configuration, IMemoryCache cache)
        {
        ...
        public void SetCache(string text, string from, string to, object value)
        {
